/*
	...
	Target instance:	(any)
	Generated date:		25/07/2017 16:04:52
...
GO
IF NOT EXISTS (SELECT 1 FROM [$(DatabaseName)].[dbo].[__MigrationLogCurrent] WHERE [migration_id] = CAST ('2c98d0be-61cb-4776-9ba5-152add0adee2' AS UNIQUEIDENTIFIER))
  PRINT '

***** EXECUTING MIGRATION "Migrations\1.0.1\008_RemoveUniqueifiedBusinessKeys.sql", ID: {2c98d0be-61cb-4776-9ba5-152add0adee2} *****';
...
GO
IF NOT EXISTS (SELECT 1 FROM [$(DatabaseName)].[dbo].[__MigrationLogCurrent] WHERE [migration_id] = CAST ('2c98d0be-61cb-4776-9ba5-152add0adee2' AS UNIQUEIDENTIFIER))
  EXECUTE ('ALTER TABLE [qvstg].[Invoice] DROP CONSTRAINT [AK_qvstg_Invoice_UniqueifiedBusinessKey]
');

GO
IF NOT EXISTS (SELECT 1 FROM [$(DatabaseName)].[dbo].[__MigrationLogCurrent] WHERE [migration_id] = CAST ('2c98d0be-61cb-4776-9ba5-152add0adee2' AS UNIQUEIDENTIFIER))
  EXECUTE ('PRINT N''Dropping constraints from [qvstg].[OrderBacklog]''
');

GO
IF NOT EXISTS (SELECT 1 FROM [$(DatabaseName)].[dbo].[__MigrationLogCurrent] WHERE [migration_id] = CAST ('2c98d0be-61cb-4776-9ba5-152add0adee2' AS UNIQUEIDENTIFIER))
  EXECUTE ('ALTER TABLE [qvstg].[OrderBacklog] DROP CONSTRAINT [AK_qvstg_OrderBacklog_UniqueifiedBusinessKey]
');

GO
IF NOT EXISTS (SELECT 1 FROM [$(DatabaseName)].[dbo].[__MigrationLogCurrent] WHERE [migration_id] = CAST ('2c98d0be-61cb-4776-9ba5-152add0adee2' AS UNIQUEIDENTIFIER))
  EXECUTE ('PRINT N''Dropping constraints from [qvstg].[OrderShippedNotInvoiced]''
');

GO
IF NOT EXISTS (SELECT 1 FROM [$(DatabaseName)].[dbo].[__MigrationLogCurrent] WHERE [migration_id] = CAST ('2c98d0be-61cb-4776-9ba5-152add0adee2' AS UNIQUEIDENTIFIER))
  EXECUTE ('ALTER TABLE [qvstg].[OrderShippedNotInvoiced] DROP CONSTRAINT [AK_qvstg_OrderShippedNotInvoiced_UniqueifiedBusinessKey]
');

GO
IF NOT EXISTS (SELECT 1 FROM [$(DatabaseName)].[dbo].[__MigrationLogCurrent] WHERE [migration_id] = CAST ('2c98d0be-61cb-4776-9ba5-152add0adee2' AS UNIQUEIDENTIFIER))
  PRINT '***** FINISHED EXECUTING MIGRATION "Migrations\1.0.1\008_RemoveUniqueifiedBusinessKeys.sql", ID: {2c98d0be-61cb-4776-9ba5-152add0adee2} *****
';

GO
IF NOT EXISTS (SELECT 1 FROM [$(DatabaseName)].[dbo].[__MigrationLogCurrent] WHERE [migration_id] = CAST ('2c98d0be-61cb-4776-9ba5-152add0adee2' AS UNIQUEIDENTIFIER))
  INSERT [$(DatabaseName)].[dbo].[__MigrationLog] ([migration_id], [script_checksum], [script_filename], [complete_dt], [applied_by], [deployed], [version], [package_version], [release_version])
  VALUES                                         (CAST ('2c98d0be-61cb-4776-9ba5-152add0adee2' AS UNIQUEIDENTIFIER), 'B5D6B5D87D1E5F68AEC467AF69A07743ECD9576DD25C412F052655918F931520', 'Migrations\1.0.1\008_RemoveUniqueifiedBusinessKeys.sql', SYSDATETIME(), SYSTEM_USER, 1, '1.0.1', '$(PackageVersion)', CASE '$(ReleaseVersion)' WHEN '' THEN NULL ELSE '$(ReleaseVersion)' END);
...
***** EXECUTING MIGRATION "Migrations\1.0.1\009_AddColumn_InvoiceQtyUoMConformed.sql", ID: {6ec51e92-1659-468f-b881-19c53641ac3f} *****';
...
GO
IF NOT EXISTS (SELECT 1 FROM [$(DatabaseName)].[dbo].[__MigrationLogCurrent] WHERE [migration_id] = CAST ('6ec51e92-1659-468f-b881-19c53641ac3f' AS UNIQUEIDENTIFIER))
  PRINT '***** FINISHED EXECUTING MIGRATION "Migrations\1.0.1\009_AddColumn_InvoiceQtyUoMConformed.sql", ID: {6ec51e92-1659-468f-b881-19c53641ac3f} *****
';
...
GO
IF NOT EXISTS (SELECT 1 FROM [$(DatabaseName)].[dbo].[__MigrationLogCurrent] WHERE [migration_id] = CAST ('04d35d57-5cc1-48b8-a110-f739ab501612' AS UNIQUEIDENTIFIER))
  PRINT '

***** EXECUTING MIGRATION "Migrations\1.0.2\001_GrantExtraRolesSelectOnPbiSchema.sql", ID: {04d35d57-5cc1-48b8-a110-f739ab501612} *****';
...
GO
IF NOT EXISTS (SELECT 1 FROM [$(DatabaseName)].[dbo].[__MigrationLogCurrent] WHERE [migration_id] = CAST ('04d35d57-5cc1-48b8-a110-f739ab501612' AS UNIQUEIDENTIFIER))
  EXECUTE ('GRANT SELECT ON SCHEMA:: [pbi] TO [AppDevelopersPROD]
');

GO
IF NOT EXISTS (SELECT 1 FROM [$(DatabaseName)].[dbo].[__MigrationLogCurrent] WHERE [migration_id] = CAST ('04d35d57-5cc1-48b8-a110-f739ab501612' AS UNIQUEIDENTIFIER))
  EXECUTE ('GRANT SELECT ON SCHEMA:: [pbi] TO [BusinessAnalystsPROD]
');

GO
IF NOT EXISTS (SELECT 1 FROM [$(DatabaseName)].[dbo].[__MigrationLogCurrent] WHERE [migration_id] = CAST ('04d35d57-5cc1-48b8-a110-f739ab501612' AS UNIQUEIDENTIFIER))
  PRINT '***** FINISHED EXECUTING MIGRATION "Migrations\1.0.2\001_GrantExtraRolesSelectOnPbiSchema.sql", ID: {04d35d57-5cc1-48b8-a110-f739ab501612} *****
';

GO
IF NOT EXISTS (SELECT 1 FROM [$(DatabaseName)].[dbo].[__MigrationLogCurrent] WHERE [migration_id] = CAST ('04d35d57-5cc1-48b8-a110-f739ab501612' AS UNIQUEIDENTIFIER))
  INSERT [$(DatabaseName)].[dbo].[__MigrationLog] ([migration_id], [script_checksum], [script_filename], [complete_dt], [applied_by], [deployed], [version], [package_version], [release_version])
  VALUES                                         (CAST ('04d35d57-5cc1-48b8-a110-f739ab501612' AS UNIQUEIDENTIFIER), 'B7C7D5400618F55EC962669F6D7D4CB4F81B11320DC6A85EA07B33E22A488BDC', 'Migrations\1.0.2\001_GrantExtraRolesSelectOnPbiSchema.sql', SYSDATETIME(), SYSTEM_USER, 1, '1.0.2', '$(PackageVersion)', CASE '$(ReleaseVersion)' WHEN '' THEN NULL ELSE '$(ReleaseVersion)' END);
