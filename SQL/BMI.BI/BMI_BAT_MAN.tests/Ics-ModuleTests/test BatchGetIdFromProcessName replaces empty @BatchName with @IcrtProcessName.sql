create   procedure [Ics-ModuleTests].[test BatchGetIdFromProcessName replaces empty @BatchName with @IcrtProcessName]
as
begin
	--! Assemble
	...
	--! Act
	exec ics.BatchGetIdFromProcessName @IcrtProcessName = @_IcrtProcessName_B, @BatchName = ''
