IF OBJECT_ID('[Ics-ModuleTests].[test IcrtSubProcessGetId throws exception on @IcrtSubProcessName null]') IS NOT NULL
	DROP PROCEDURE [Ics-ModuleTests].[test IcrtSubProcessGetId throws exception on @IcrtSubProcessName null];
