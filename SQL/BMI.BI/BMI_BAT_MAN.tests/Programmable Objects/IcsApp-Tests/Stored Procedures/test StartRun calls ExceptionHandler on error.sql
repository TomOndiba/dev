IF OBJECT_ID('[IcsApp-Tests].[test StartRun calls ExceptionHandler on error]') IS NOT NULL
	DROP PROCEDURE [IcsApp-Tests].[test StartRun calls ExceptionHandler on error];
