IF OBJECT_ID('[IcsApp-Tests].[test StartRun throws error on @ProcessName null]') IS NOT NULL
	DROP PROCEDURE [IcsApp-Tests].[test StartRun throws error on @ProcessName null];
...
SET ANSI_NULLS ON
GO
create   procedure [IcsApp-Tests].[test StartRun throws error on @ProcessName null]
as
begin
