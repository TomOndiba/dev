IF OBJECT_ID('[IcsApp-Tests].[test StartRun throws error on @ProcessRunId negative when starting a sub-process]') IS NOT NULL
	DROP PROCEDURE [IcsApp-Tests].[test StartRun throws error on @ProcessRunId negative when starting a sub-process];
