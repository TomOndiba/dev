IF OBJECT_ID('[IcsApp-Tests].[test StopRun throws error on @ProcessName null]') IS NOT NULL
	DROP PROCEDURE [IcsApp-Tests].[test StopRun throws error on @ProcessName null];
