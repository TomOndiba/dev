IF OBJECT_ID('[IcsApp-Tests].[test StopRun throws error on @SuccessSourceRows negative when ending a thread]') IS NOT NULL
	DROP PROCEDURE [IcsApp-Tests].[test StopRun throws error on @SuccessSourceRows negative when ending a thread];
