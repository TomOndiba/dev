IF OBJECT_ID('[batch-ModuleTests].[test ProcessGetIdFromIcrtProcessName replaces empty @BatchProcessName with @IcrtProcessName]') IS NOT NULL
	DROP PROCEDURE [batch-ModuleTests].[test ProcessGetIdFromIcrtProcessName replaces empty @BatchProcessName with @IcrtProcessName];
