CREATE procedure [etl-ModuleTests].[test CheckForDuplicateQlikViewTransactions throws error on multiple cross-table duplicates]
as
begin
	...
	exec tSQLt.ExpectException
		...
		, @ExpectedMessagePattern = 'Check for Duplicates failed!  Invoice: 1 record(s) duplicated;  Order Backlog: 5 record(s) duplicated;  Order SNI: 2 record(s) duplicated%'
