-- <Migration ID="da18fd29-27d4-4a74-a98d-6d45616db944" />
GO
...
GO
PRINT N'Creating primary key [PK_qvstg_TranslationColour] on [qvstg].[TranslationColour]'
GO
ALTER TABLE [qvstg].[TranslationColour] ADD CONSTRAINT [PK_qvstg_TranslationColour] PRIMARY KEY CLUSTERED  ([TranslationColourId])
GO
PRINT N'Adding constraints to [qvstg].[TranslationColour]'
GO
...
GO
PRINT N'Adding foreign keys to [qvstg].[TranslationColour]'
GO
