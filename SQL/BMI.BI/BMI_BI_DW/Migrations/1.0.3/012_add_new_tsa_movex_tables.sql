-- <Migration ID="14989ddd-0515-44a6-9a61-afb59cec9d35" />
go

print N'Dropping [tsa].[ics_land_movex_...] tables' ;
go
if objectpropertyex(object_id(N'[tsa].[ics_land_movex_CCURRA]'), N'IsUserTable') is not null drop table [tsa].[ics_land_movex_CCURRA]
go
if objectpropertyex(object_id(N'[tsa].[ics_land_movex_CSYTAB]'), N'IsUserTable') is not null drop table [tsa].[ics_land_movex_CSYTAB]
go
if objectpropertyex(object_id(N'[tsa].[ics_land_movex_MILOMA]'), N'IsUserTable') is not null drop table [tsa].[ics_land_movex_MILOMA]
go
if objectpropertyex(object_id(N'[tsa].[ics_land_movex_MITAUN]'), N'IsUserTable') is not null drop table [tsa].[ics_land_movex_MITAUN]
go
if objectpropertyex(object_id(N'[tsa].[ics_land_movex_MITBAL]'), N'IsUserTable') is not null drop table [tsa].[ics_land_movex_MITBAL]
go
if objectpropertyex(object_id(N'[tsa].[ics_land_movex_MITFAC]'), N'IsUserTable') is not null drop table [tsa].[ics_land_movex_MITFAC]
go
if objectpropertyex(object_id(N'[tsa].[ics_land_movex_MITLOC]'), N'IsUserTable') is not null drop table [tsa].[ics_land_movex_MITLOC]
go
if objectpropertyex(object_id(N'[tsa].[ics_land_movex_MITMAS]'), N'IsUserTable') is not null drop table [tsa].[ics_land_movex_MITMAS]
go
if objectpropertyex(object_id(N'[tsa].[ics_land_movex_OCHCUS]'), N'IsUserTable') is not null drop table [tsa].[ics_land_movex_OCHCUS]
go
if objectpropertyex(object_id(N'[tsa].[ics_land_movex_OCUSMA]'), N'IsUserTable') is not null drop table [tsa].[ics_land_movex_OCUSMA]
go
if objectpropertyex(object_id(N'[tsa].[ics_land_movex_OINVOH]'), N'IsUserTable') is not null drop table [tsa].[ics_land_movex_OINVOH]
go
if objectpropertyex(object_id(N'[tsa].[ics_land_movex_OINVOL]'), N'IsUserTable') is not null drop table [tsa].[ics_land_movex_OINVOL]
go
if objectpropertyex(object_id(N'[tsa].[ics_land_movex_OOHEAD]'), N'IsUserTable') is not null drop table [tsa].[ics_land_movex_OOHEAD]
go
if objectpropertyex(object_id(N'[tsa].[ics_land_movex_OOLINE]'), N'IsUserTable') is not null drop table [tsa].[ics_land_movex_OOLINE]
go
if objectpropertyex(object_id(N'[tsa].[ics_land_movex_OSBSTD]'), N'IsUserTable') is not null drop table [tsa].[ics_land_movex_OSBSTD]
go

print N'Creating [tsa].[ics_land_movex_CCURRA]' ;
go
create table [tsa].[ics_land_movex_CCURRA]
(
...
, ExcludeFromMerge bit not null constraint DF_tsa_ics_land_movex_CCURRA_ExcludeFromMerge default (0)
, IsDuplicate bit not null constraint DF_tsa_ics_land_movex_CCURRA_IsDuplicate default (0)
...
go
print N'Creating [tsa].[ics_land_movex_CSYTAB]' ;
go
create table [tsa].[ics_land_movex_CSYTAB]
(
  EtlBatchRunId int not null
, EtlStepRunId int not null
, EtlThreadRunId int not null
...
, EtlCreatedOn datetime not null
, EtlCreatedBy varchar(200) not null
, ExcludeFromMerge bit not null constraint DF_tsa_ics_land_movex_CSYTAB_ExcludeFromMerge default (0)
, IsDuplicate bit not null constraint DF_tsa_ics_land_movex_CSYTAB_IsDuplicate default (0)
...
go
print N'Creating [tsa].[ics_land_movex_MILOMA]' ;
go
create table [tsa].[ics_land_movex_MILOMA]
(
  EtlBatchRunId int not null
, EtlStepRunId int not null
, EtlThreadRunId int not null
...
, EtlCreatedOn datetime not null
, EtlCreatedBy varchar(200) not null
, ExcludeFromMerge bit not null constraint DF_tsa_ics_land_movex_MILOMA_ExcludeFromMerge default (0)
, IsDuplicate bit not null constraint DF_tsa_ics_land_movex_MILOMA_IsDuplicate default (0)

, LMCONO decimal(3, 0) null -- "Company" is decimal(3,0)
...
go
print N'Creating [tsa].[ics_land_movex_MITAUN]' ;
go
...
go
print N'Creating [tsa].[ics_land_movex_MITBAL]' ;
go
create table [tsa].[ics_land_movex_MITBAL]
(
  EtlBatchRunId int not null
, EtlStepRunId int not null
, EtlThreadRunId int not null
...
, EtlCreatedOn datetime not null
, EtlCreatedBy varchar(200) not null
, ExcludeFromMerge bit not null constraint DF_tsa_ics_land_movex_MITBAL_ExcludeFromMerge default (0)
, IsDuplicate bit not null constraint DF_tsa_ics_land_movex_MITBAL_IsDuplicate default (0)
...
go
print N'Creating [tsa].[ics_land_movex_MITFAC]' ;
go
...
go
print N'Creating [tsa].[ics_land_movex_MITLOC]' ;
go
create table [tsa].[ics_land_movex_MITLOC]
(
  EtlBatchRunId int not null
, EtlStepRunId int not null
, EtlThreadRunId int not null
...
, EtlCreatedOn datetime not null
, EtlCreatedBy varchar(200) not null
, ExcludeFromMerge bit not null constraint DF_tsa_ics_land_movex_MITLOC_ExcludeFromMerge default (0)
, IsDuplicate bit not null constraint DF_tsa_ics_land_movex_MITLOC_IsDuplicate default (0)
...
go
print N'Creating [tsa].[ics_land_movex_MITMAS]' ;
go
create table [tsa].[ics_land_movex_MITMAS]
(
  EtlBatchRunId int not null
, EtlStepRunId int not null
, EtlThreadRunId int not null
...
, EtlCreatedOn datetime not null
, EtlCreatedBy varchar(200) not null
, ExcludeFromMerge bit not null constraint DF_tsa_ics_land_movex_MITMAS_ExcludeFromMerge default (0)
, IsDuplicate bit not null constraint DF_tsa_ics_land_movex_MITMAS_IsDuplicate default (0)
...
go
print N'Creating [tsa].[ics_land_movex_OCHCUS]' ;
go
create table [tsa].[ics_land_movex_OCHCUS]
(
  EtlBatchRunId int not null
, EtlStepRunId int not null
, EtlThreadRunId int not null
...
, EtlCreatedOn datetime not null
, EtlCreatedBy varchar(200) not null
, ExcludeFromMerge bit not null constraint DF_tsa_ics_land_movex_OCHCUS_ExcludeFromMerge default (0)
, IsDuplicate bit not null constraint DF_tsa_ics_land_movex_OCHCUS_IsDuplicate default (0)
...
go
print N'Creating [tsa].[ics_land_movex_OCUSMA]' ;
go
create table [tsa].[ics_land_movex_OCUSMA]
(
  EtlBatchRunId int not null
, EtlStepRunId int not null
, EtlThreadRunId int not null
...
, EtlCreatedOn datetime not null
, EtlCreatedBy varchar(200) not null
, ExcludeFromMerge bit not null constraint DF_tsa_ics_land_movex_OCUSMA_ExcludeFromMerge default (0)
, IsDuplicate bit not null constraint DF_tsa_ics_land_movex_OCUSMA_IsDuplicate default (0)
...
go
print N'Creating [tsa].[ics_land_movex_OINVOH]' ;
go
create table [tsa].[ics_land_movex_OINVOH]
(
  EtlBatchRunId int not null
, EtlStepRunId int not null
, EtlThreadRunId int not null
...
, EtlCreatedOn datetime not null
, EtlCreatedBy varchar(200) not null
, ExcludeFromMerge bit not null constraint DF_tsa_ics_land_movex_OINVOH_ExcludeFromMerge default (0)
, IsDuplicate bit not null constraint DF_tsa_ics_land_movex_OINVOH_IsDuplicate default (0)
...
go
print N'Creating [tsa].[ics_land_movex_OINVOL]' ;
go
create table [tsa].[ics_land_movex_OINVOL]
(
  EtlBatchRunId int not null
, EtlStepRunId int not null
, EtlThreadRunId int not null
...
, EtlCreatedOn datetime not null
, EtlCreatedBy varchar(200) not null
, ExcludeFromMerge bit not null constraint DF_tsa_ics_land_movex_OINVOL_ExcludeFromMerge default (0)
, IsDuplicate bit not null constraint DF_tsa_ics_land_movex_OINVOL_IsDuplicate default (0)
...
go
print N'Creating [tsa].[ics_land_movex_OOHEAD]' ;
go
create table [tsa].[ics_land_movex_OOHEAD]
(
  EtlBatchRunId int not null
, EtlStepRunId int not null
, EtlThreadRunId int not null
...
, EtlCreatedOn datetime not null
, EtlCreatedBy varchar(200) not null
, ExcludeFromMerge bit not null constraint DF_tsa_ics_land_movex_OOHEAD_ExcludeFromMerge default (0)
, IsDuplicate bit not null constraint DF_tsa_ics_land_movex_OOHEAD_IsDuplicate default (0)
...
go
print N'Creating [tsa].[ics_land_movex_OOLINE]' ;
go
create table [tsa].[ics_land_movex_OOLINE]
(
  EtlBatchRunId int not null
, EtlStepRunId int not null
, EtlThreadRunId int not null
...
, EtlCreatedOn datetime not null
, EtlCreatedBy varchar(200) not null
, ExcludeFromMerge bit not null constraint DF_tsa_ics_land_movex_OOLINE_ExcludeFromMerge default (0)
, IsDuplicate bit not null constraint DF_tsa_ics_land_movex_OOLINE_IsDuplicate default (0)
...
go
print N'Creating [tsa].[ics_land_movex_OSBSTD]' ;
go
