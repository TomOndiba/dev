-- <Migration ID="47795f57-82d2-48d4-b89e-aa02255ef8a5" />
go


if objectpropertyex(object_id(N'[tsa].[ics_land_m3_CCURRA]'), N'IsUserTable') is not null drop table [tsa].[ics_land_m3_CCURRA]
go
if objectpropertyex(object_id(N'[tsa].[ics_land_m3_CSYTAB]'), N'IsUserTable') is not null drop table [tsa].[ics_land_m3_CSYTAB]
go
if objectpropertyex(object_id(N'[tsa].[ics_land_m3_MILOMA]'), N'IsUserTable') is not null drop table [tsa].[ics_land_m3_MILOMA]
go
if objectpropertyex(object_id(N'[tsa].[ics_land_m3_MITAUN]'), N'IsUserTable') is not null drop table [tsa].[ics_land_m3_MITAUN]
go
if objectpropertyex(object_id(N'[tsa].[ics_land_m3_MITBAL]'), N'IsUserTable') is not null drop table [tsa].[ics_land_m3_MITBAL]
go
if objectpropertyex(object_id(N'[tsa].[ics_land_m3_MITFAC]'), N'IsUserTable') is not null drop table [tsa].[ics_land_m3_MITFAC]
go
if objectpropertyex(object_id(N'[tsa].[ics_land_m3_MITLOC]'), N'IsUserTable') is not null drop table [tsa].[ics_land_m3_MITLOC]
go
if objectpropertyex(object_id(N'[tsa].[ics_land_m3_MITMAS]'), N'IsUserTable') is not null drop table [tsa].[ics_land_m3_MITMAS]
go
if objectpropertyex(object_id(N'[tsa].[ics_land_m3_MITPOP]'), N'IsUserTable') is not null drop table [tsa].[ics_land_m3_MITPOP]
go
if objectpropertyex(object_id(N'[tsa].[ics_land_m3_OCHCUS]'), N'IsUserTable') is not null drop table [tsa].[ics_land_m3_OCHCUS]
go
if objectpropertyex(object_id(N'[tsa].[ics_land_m3_OCUSMA]'), N'IsUserTable') is not null drop table [tsa].[ics_land_m3_OCUSMA]
go
if objectpropertyex(object_id(N'[tsa].[ics_land_m3_OINVOH]'), N'IsUserTable') is not null drop table [tsa].[ics_land_m3_OINVOH]
go
if objectpropertyex(object_id(N'[tsa].[ics_land_m3_OINVOL]'), N'IsUserTable') is not null drop table [tsa].[ics_land_m3_OINVOL]
go
if objectpropertyex(object_id(N'[tsa].[ics_land_m3_OOHEAD]'), N'IsUserTable') is not null drop table [tsa].[ics_land_m3_OOHEAD]
go
if objectpropertyex(object_id(N'[tsa].[ics_land_m3_OOLINE]'), N'IsUserTable') is not null drop table [tsa].[ics_land_m3_OOLINE]
go
if objectpropertyex(object_id(N'[tsa].[ics_land_m3_OSBSTD]'), N'IsUserTable') is not null drop table [tsa].[ics_land_m3_OSBSTD]
go
print N'Creating [tsa].[ics_land_m3_CCURRA]' ;
go
create table [tsa].[ics_land_m3_CCURRA]
(
...
, ExcludeFromMerge bit not null constraint DF_tsa_ics_land_m3_CCURRA_ExcludeFromMerge default (0)
, IsDuplicate bit not null constraint DF_tsa_ics_land_m3_CCURRA_IsDuplicate default (0)
...
go
print N'Creating [tsa].[ics_land_m3_CSYTAB]' ;
go
...
go
print N'Creating [tsa].[ics_land_m3_MILOMA]' ;
go
...
go
print N'Creating [tsa].[ics_land_m3_MITAUN]' ;
go
...
go
print N'Creating [tsa].[ics_land_m3_MITBAL]' ;
go
...
go
print N'Creating [tsa].[ics_land_m3_MITFAC]' ;
go
create table [tsa].[ics_land_m3_MITFAC]
(
  EtlBatchRunId int not null
, EtlStepRunId int not null
, EtlThreadRunId int not null
...
, EtlCreatedOn datetime not null
, EtlCreatedBy varchar(200) not null
, ExcludeFromMerge bit not null constraint DF_tsa_ics_land_m3_MITFAC_ExcludeFromMerge default (0)
, IsDuplicate bit not null constraint DF_tsa_ics_land_m3_MITFAC_IsDuplicate default (0)
...
go
print N'Creating [tsa].[ics_land_m3_MITLOC]' ;
go
...
go
print N'Creating [tsa].[ics_land_m3_MITMAS]' ;
go
...
go
print N'Creating [tsa].[ics_land_m3_MITPOP]' ;
go
...
go
print N'Creating [tsa].[ics_land_m3_OCHCUS]' ;
go
...
go
print N'Creating [tsa].[ics_land_m3_OCUSMA]' ;
go
create table [tsa].[ics_land_m3_OCUSMA]
(
  EtlBatchRunId int not null
, EtlStepRunId int not null
, EtlThreadRunId int not null
...
, EtlCreatedOn datetime not null
, EtlCreatedBy varchar(200) not null
, ExcludeFromMerge bit not null constraint DF_tsa_ics_land_m3_OCUSMA_ExcludeFromMerge default (0)
, IsDuplicate bit not null constraint DF_tsa_ics_land_m3_OCUSMA_IsDuplicate default (0)
...
go
print N'Creating [tsa].[ics_land_m3_OINVOH]' ;
go
create table [tsa].[ics_land_m3_OINVOH]
(
  EtlBatchRunId int not null
, EtlStepRunId int not null
, EtlThreadRunId int not null
...
, EtlCreatedOn datetime not null
, EtlCreatedBy varchar(200) not null
, ExcludeFromMerge bit not null constraint DF_tsa_ics_land_m3_OINVOH_ExcludeFromMerge default (0)
, IsDuplicate bit not null constraint DF_tsa_ics_land_m3_OINVOH_IsDuplicate default (0)
...
go
print N'Creating [tsa].[ics_land_m3_OINVOL]' ;
go
...
go
print N'Creating [tsa].[ics_land_m3_OOHEAD]' ;
go
create table [tsa].[ics_land_m3_OOHEAD]
(
  EtlBatchRunId int not null
, EtlStepRunId int not null
, EtlThreadRunId int not null
...
, EtlCreatedOn datetime not null
, EtlCreatedBy varchar(200) not null
, ExcludeFromMerge bit not null constraint DF_tsa_ics_land_m3_OOHEAD_ExcludeFromMerge default (0)
, IsDuplicate bit not null constraint DF_tsa_ics_land_m3_OOHEAD_IsDuplicate default (0)
...
go
print N'Creating [tsa].[ics_land_m3_OOLINE]' ;
go
create table [tsa].[ics_land_m3_OOLINE]
(
  EtlBatchRunId int not null
, EtlStepRunId int not null
, EtlThreadRunId int not null
...
, EtlCreatedOn datetime not null
, EtlCreatedBy varchar(200) not null
, ExcludeFromMerge bit not null constraint DF_tsa_ics_land_m3_OOLINE_ExcludeFromMerge default (0)
, IsDuplicate bit not null constraint DF_tsa_ics_land_m3_OOLINE_IsDuplicate default (0)
...
go
print N'Creating [tsa].[ics_land_m3_OSBSTD]' ;
go
create table [tsa].[ics_land_m3_OSBSTD]
(
  EtlBatchRunId int not null
, EtlStepRunId int not null
, EtlThreadRunId int not null
...
, EtlCreatedOn datetime not null
, EtlCreatedBy varchar(200) not null
, ExcludeFromMerge bit not null constraint DF_tsa_ics_land_m3_OSBSTD_ExcludeFromMerge default (0)
, IsDuplicate bit not null constraint DF_tsa_ics_land_m3_OSBSTD_IsDuplicate default (0)
