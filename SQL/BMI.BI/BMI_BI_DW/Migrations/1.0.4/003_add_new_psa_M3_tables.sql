-- <Migration ID="02ec9a1e-2ef0-4954-931a-0b74a8ecd3ec" />
go

print N'Dropping [psa].[ics_stg_m3_...] tables' ;
go
if objectpropertyex(object_id(N'[psa].[ics_stg_m3_CCURRA]'), N'IsUserTable') is not null drop table [psa].[ics_stg_m3_CCURRA]
go
if objectpropertyex(object_id(N'[psa].[ics_stg_m3_CSYTAB]'), N'IsUserTable') is not null drop table [psa].[ics_stg_m3_CSYTAB]
go
if objectpropertyex(object_id(N'[psa].[ics_stg_m3_MILOMA]'), N'IsUserTable') is not null drop table [psa].[ics_stg_m3_MILOMA]
go
if objectpropertyex(object_id(N'[psa].[ics_stg_m3_MITAUN]'), N'IsUserTable') is not null drop table [psa].[ics_stg_m3_MITAUN]
go
if objectpropertyex(object_id(N'[psa].[ics_stg_m3_MITBAL]'), N'IsUserTable') is not null drop table [psa].[ics_stg_m3_MITBAL]
go
if objectpropertyex(object_id(N'[psa].[ics_stg_m3_MITFAC]'), N'IsUserTable') is not null drop table [psa].[ics_stg_m3_MITFAC]
go
if objectpropertyex(object_id(N'[psa].[ics_stg_m3_MITLOC]'), N'IsUserTable') is not null drop table [psa].[ics_stg_m3_MITLOC]
go
if objectpropertyex(object_id(N'[psa].[ics_stg_m3_MITMAS]'), N'IsUserTable') is not null drop table [psa].[ics_stg_m3_MITMAS]
go
if objectpropertyex(object_id(N'[psa].[ics_stg_m3_MITPOP]'), N'IsUserTable') is not null drop table [psa].[ics_stg_m3_MITPOP]
go
if objectpropertyex(object_id(N'[psa].[ics_stg_m3_OCHCUS]'), N'IsUserTable') is not null drop table [psa].[ics_stg_m3_OCHCUS]
go
if objectpropertyex(object_id(N'[psa].[ics_stg_m3_OCUSMA]'), N'IsUserTable') is not null drop table [psa].[ics_stg_m3_OCUSMA]
go
if objectpropertyex(object_id(N'[psa].[ics_stg_m3_OINVOH]'), N'IsUserTable') is not null drop table [psa].[ics_stg_m3_OINVOH]
go
if objectpropertyex(object_id(N'[psa].[ics_stg_m3_OINVOL]'), N'IsUserTable') is not null drop table [psa].[ics_stg_m3_OINVOL]
go
if objectpropertyex(object_id(N'[psa].[ics_stg_m3_OOHEAD]'), N'IsUserTable') is not null drop table [psa].[ics_stg_m3_OOHEAD]
go
if objectpropertyex(object_id(N'[psa].[ics_stg_m3_OOLINE]'), N'IsUserTable') is not null drop table [psa].[ics_stg_m3_OOLINE]
go
if objectpropertyex(object_id(N'[psa].[ics_stg_m3_OSBSTD]'), N'IsUserTable') is not null drop table [psa].[ics_stg_m3_OSBSTD]
go
print N'Creating [psa].[ics_stg_m3_CCURRA]' ;
go
...
go
print N'Creating [psa].[ics_stg_m3_CSYTAB]' ;
go
create table [psa].[ics_stg_m3_CSYTAB]
(
  EtlRecordId bigint not null identity(1,1)
, EtlBatchRunId int not null
, EtlStepRunId int not null
...
, EtlDeletedOn datetime null
, EtlDeletedBy varchar(200) null
, IsDeleted char(1) not null constraint DF_psa_ics_stg_m3_CSYTAB_IsDeleted default ('N')
, IsIncomplete char(1) not null constraint DF_psa_ics_stg_m3_CSYTAB_IsIncomplete default ('N')
...
go
print N'Creating [psa].[ics_stg_m3_MILOMA]' ;
go
create table [psa].[ics_stg_m3_MILOMA]
(
  EtlRecordId bigint not null identity(1,1)
, EtlBatchRunId int not null
, EtlStepRunId int not null
...
, EtlDeletedOn datetime null
, EtlDeletedBy varchar(200) null
, IsDeleted char(1) not null constraint DF_psa_ics_stg_m3_MILOMA_IsDeleted default ('N')
, IsIncomplete char(1) not null constraint DF_psa_ics_stg_m3_MILOMA_IsIncomplete default ('N')
...
go
print N'Creating [psa].[ics_stg_m3_MITAUN]' ;
go
create table [psa].[ics_stg_m3_MITAUN]
(
  EtlRecordId bigint not null identity(1,1)
, EtlBatchRunId int not null
, EtlStepRunId int not null
...
, EtlDeletedOn datetime null
, EtlDeletedBy varchar(200) null
, IsDeleted char(1) not null constraint DF_psa_ics_stg_m3_MITAUN_IsDeleted default ('N')
, IsIncomplete char(1) not null constraint DF_psa_ics_stg_m3_MITAUN_IsIncomplete default ('N')
...
go
print N'Creating [psa].[ics_stg_m3_MITBAL]' ;
go
create table [psa].[ics_stg_m3_MITBAL]
(
  EtlRecordId bigint not null identity(1,1)
, EtlBatchRunId int not null
, EtlStepRunId int not null
...
, EtlDeletedOn datetime null
, EtlDeletedBy varchar(200) null
, IsDeleted char(1) not null constraint DF_psa_ics_stg_m3_MITBAL_IsDeleted default ('N')
, IsIncomplete char(1) not null constraint DF_psa_ics_stg_m3_MITBAL_IsIncomplete default ('N')
...
go
print N'Creating [psa].[ics_stg_m3_MITFAC]' ;
go
...
go
print N'Creating [psa].[ics_stg_m3_MITLOC]' ;
go
create table [psa].[ics_stg_m3_MITLOC]
(
  EtlRecordId bigint not null identity(1,1)
, EtlBatchRunId int not null
, EtlStepRunId int not null
...
, EtlDeletedOn datetime null
, EtlDeletedBy varchar(200) null
, IsDeleted char(1) not null constraint DF_psa_ics_stg_m3_MITLOC_IsDeleted default ('N')
, IsIncomplete char(1) not null constraint DF_psa_ics_stg_m3_MITLOC_IsIncomplete default ('N')
...
go
print N'Creating [psa].[ics_stg_m3_MITMAS]' ;
go
create table [psa].[ics_stg_m3_MITMAS]
(
  EtlRecordId bigint not null identity(1,1)
, EtlBatchRunId int not null
, EtlStepRunId int not null
...
, EtlDeletedOn datetime null
, EtlDeletedBy varchar(200) null
, IsDeleted char(1) not null constraint DF_psa_ics_stg_m3_MITMAS_IsDeleted default ('N')
, IsIncomplete char(1) not null constraint DF_psa_ics_stg_m3_MITMAS_IsIncomplete default ('N')
...
go
print N'Creating [psa].[ics_stg_m3_MITPOP]' ;
go
create table [psa].[ics_stg_m3_MITPOP]
(
  EtlRecordId bigint not null identity(1,1)
, EtlBatchRunId int not null
, EtlStepRunId int not null
...
, EtlDeletedOn datetime null
, EtlDeletedBy varchar(200) null
, IsDeleted char(1) not null constraint DF_psa_ics_stg_m3_MITPOP_IsDeleted default ('N')
, IsIncomplete char(1) not null constraint DF_psa_ics_stg_m3_MITPOP_IsIncomplete default ('N')
...
go
print N'Creating [psa].[ics_stg_m3_OCHCUS]' ;
go
...
go
print N'Creating [psa].[ics_stg_m3_OCUSMA]' ;
go
create table [psa].[ics_stg_m3_OCUSMA]
(
  EtlRecordId bigint not null identity(1,1)
, EtlBatchRunId int not null
, EtlStepRunId int not null
...
, EtlDeletedOn datetime null
, EtlDeletedBy varchar(200) null
, IsDeleted char(1) not null constraint DF_psa_ics_stg_m3_OCUSMA_IsDeleted default ('N')
, IsIncomplete char(1) not null constraint DF_psa_ics_stg_m3_OCUSMA_IsIncomplete default ('N')
...
go
print N'Creating [psa].[ics_stg_m3_OINVOH]' ;
go
...
go
print N'Creating [psa].[ics_stg_m3_OINVOL]' ;
go
...
go
print N'Creating [psa].[ics_stg_m3_OOHEAD]' ;
go
create table [psa].[ics_stg_m3_OOHEAD]
(
  EtlRecordId bigint not null identity(1,1)
, EtlBatchRunId int not null
, EtlStepRunId int not null
...
go
print N'Creating [psa].[ics_stg_m3_OOLINE]' ;
go
create table [psa].[ics_stg_m3_OOLINE]
(
  EtlRecordId bigint not null identity(1,1)
, EtlBatchRunId int not null
, EtlStepRunId int not null
...
, EtlDeletedOn datetime null
, EtlDeletedBy varchar(200) null
, IsDeleted char(1) not null constraint DF_psa_ics_stg_m3_OOLINE_IsDeleted default ('N')
, IsIncomplete char(1) not null constraint DF_psa_ics_stg_m3_OOLINE_IsIncomplete default ('N')
...
go
print N'Creating [psa].[ics_stg_m3_OSBSTD]' ;
go
