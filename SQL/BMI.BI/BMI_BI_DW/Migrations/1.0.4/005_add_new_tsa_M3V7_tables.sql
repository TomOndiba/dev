-- <Migration ID="3368b694-f061-4f46-ac40-59f623f21d0e" />
go

print N'Dropping [tsa].[ics_land_m3v7_...] tables' ;
go
if objectpropertyex(object_id(N'[tsa].[ics_land_m3v7_CCURRA]'), N'IsUserTable') is not null drop table [tsa].[ics_land_m3v7_CCURRA]
go
if objectpropertyex(object_id(N'[tsa].[ics_land_m3v7_CSYTAB]'), N'IsUserTable') is not null drop table [tsa].[ics_land_m3v7_CSYTAB]
go
if objectpropertyex(object_id(N'[tsa].[ics_land_m3v7_MILOMA]'), N'IsUserTable') is not null drop table [tsa].[ics_land_m3v7_MILOMA]
go
if objectpropertyex(object_id(N'[tsa].[ics_land_m3v7_MITAUN]'), N'IsUserTable') is not null drop table [tsa].[ics_land_m3v7_MITAUN]
go
if objectpropertyex(object_id(N'[tsa].[ics_land_m3v7_MITBAL]'), N'IsUserTable') is not null drop table [tsa].[ics_land_m3v7_MITBAL]
go
if objectpropertyex(object_id(N'[tsa].[ics_land_m3v7_MITFAC]'), N'IsUserTable') is not null drop table [tsa].[ics_land_m3v7_MITFAC]
go
if objectpropertyex(object_id(N'[tsa].[ics_land_m3v7_MITLOC]'), N'IsUserTable') is not null drop table [tsa].[ics_land_m3v7_MITLOC]
go
if objectpropertyex(object_id(N'[tsa].[ics_land_m3v7_MITMAS]'), N'IsUserTable') is not null drop table [tsa].[ics_land_m3v7_MITMAS]
go
if objectpropertyex(object_id(N'[tsa].[ics_land_m3v7_MITPOP]'), N'IsUserTable') is not null drop table [tsa].[ics_land_m3v7_MITPOP]
go
if objectpropertyex(object_id(N'[tsa].[ics_land_m3v7_OCHCUS]'), N'IsUserTable') is not null drop table [tsa].[ics_land_m3v7_OCHCUS]
go
if objectpropertyex(object_id(N'[tsa].[ics_land_m3v7_OCUSMA]'), N'IsUserTable') is not null drop table [tsa].[ics_land_m3v7_OCUSMA]
go
if objectpropertyex(object_id(N'[tsa].[ics_land_m3v7_OINVOH]'), N'IsUserTable') is not null drop table [tsa].[ics_land_m3v7_OINVOH]
go
if objectpropertyex(object_id(N'[tsa].[ics_land_m3v7_OINVOL]'), N'IsUserTable') is not null drop table [tsa].[ics_land_m3v7_OINVOL]
go
if objectpropertyex(object_id(N'[tsa].[ics_land_m3v7_OOHEAD]'), N'IsUserTable') is not null drop table [tsa].[ics_land_m3v7_OOHEAD]
go
if objectpropertyex(object_id(N'[tsa].[ics_land_m3v7_OOLINE]'), N'IsUserTable') is not null drop table [tsa].[ics_land_m3v7_OOLINE]
go
if objectpropertyex(object_id(N'[tsa].[ics_land_m3v7_OSBSTD]'), N'IsUserTable') is not null drop table [tsa].[ics_land_m3v7_OSBSTD]
go
print N'Creating [tsa].[ics_land_m3v7_CCURRA]' ;
go
...
go
print N'Creating [tsa].[ics_land_m3v7_CSYTAB]' ;
go
create table [tsa].[ics_land_m3v7_CSYTAB]
(
  EtlBatchRunId int not null
, EtlStepRunId int not null
, EtlThreadRunId int not null
...
, EtlCreatedOn datetime not null
, EtlCreatedBy varchar(200) not null
, ExcludeFromMerge bit not null constraint DF_tsa_ics_land_m3v7_CSYTAB_ExcludeFromMerge default (0)
, IsDuplicate bit not null constraint DF_tsa_ics_land_m3v7_CSYTAB_IsDuplicate default (0)
...
go
print N'Creating [tsa].[ics_land_m3v7_MILOMA]' ;
go
create table [tsa].[ics_land_m3v7_MILOMA]
(
  EtlBatchRunId int not null
, EtlStepRunId int not null
, EtlThreadRunId int not null
...
, EtlCreatedOn datetime not null
, EtlCreatedBy varchar(200) not null
, ExcludeFromMerge bit not null constraint DF_tsa_ics_land_m3v7_MILOMA_ExcludeFromMerge default (0)
, IsDuplicate bit not null constraint DF_tsa_ics_land_m3v7_MILOMA_IsDuplicate default (0)
...
go
print N'Creating [tsa].[ics_land_m3v7_MITAUN]' ;
go
create table [tsa].[ics_land_m3v7_MITAUN]
(
  EtlBatchRunId int not null
, EtlStepRunId int not null
, EtlThreadRunId int not null
...
, EtlCreatedOn datetime not null
, EtlCreatedBy varchar(200) not null
, ExcludeFromMerge bit not null constraint DF_tsa_ics_land_m3v7_MITAUN_ExcludeFromMerge default (0)
, IsDuplicate bit not null constraint DF_tsa_ics_land_m3v7_MITAUN_IsDuplicate default (0)
...
go
print N'Creating [tsa].[ics_land_m3v7_MITBAL]' ;
go
...
go
print N'Creating [tsa].[ics_land_m3v7_MITFAC]' ;
go
create table [tsa].[ics_land_m3v7_MITFAC]
(
  EtlBatchRunId int not null
, EtlStepRunId int not null
, EtlThreadRunId int not null
...
, EtlCreatedOn datetime not null
, EtlCreatedBy varchar(200) not null
, ExcludeFromMerge bit not null constraint DF_tsa_ics_land_m3v7_MITFAC_ExcludeFromMerge default (0)
, IsDuplicate bit not null constraint DF_tsa_ics_land_m3v7_MITFAC_IsDuplicate default (0)
...
go
print N'Creating [tsa].[ics_land_m3v7_MITLOC]' ;
go
...
go
print N'Creating [tsa].[ics_land_m3v7_MITMAS]' ;
go
create table [tsa].[ics_land_m3v7_MITMAS]
(
  EtlBatchRunId int not null
, EtlStepRunId int not null
, EtlThreadRunId int not null
...
, EtlCreatedOn datetime not null
, EtlCreatedBy varchar(200) not null
, ExcludeFromMerge bit not null constraint DF_tsa_ics_land_m3v7_MITMAS_ExcludeFromMerge default (0)
, IsDuplicate bit not null constraint DF_tsa_ics_land_m3v7_MITMAS_IsDuplicate default (0)
...
go
print N'Creating [tsa].[ics_land_m3v7_MITPOP]' ;
go
create table [tsa].[ics_land_m3v7_MITPOP]
(
  EtlBatchRunId int not null
, EtlStepRunId int not null
, EtlThreadRunId int not null
...
, EtlCreatedOn datetime not null
, EtlCreatedBy varchar(200) not null
, ExcludeFromMerge bit not null constraint DF_tsa_ics_land_m3v7_MITPOP_ExcludeFromMerge default (0)
, IsDuplicate bit not null constraint DF_tsa_ics_land_m3v7_MITPOP_IsDuplicate default (0)
...
go
print N'Creating [tsa].[ics_land_m3v7_OCHCUS]' ;
go
...
go
print N'Creating [tsa].[ics_land_m3v7_OCUSMA]' ;
go
create table [tsa].[ics_land_m3v7_OCUSMA]
(
  EtlBatchRunId int not null
, EtlStepRunId int not null
, EtlThreadRunId int not null
...
, EtlCreatedOn datetime not null
, EtlCreatedBy varchar(200) not null
, ExcludeFromMerge bit not null constraint DF_tsa_ics_land_m3v7_OCUSMA_ExcludeFromMerge default (0)
, IsDuplicate bit not null constraint DF_tsa_ics_land_m3v7_OCUSMA_IsDuplicate default (0)
...
go
print N'Creating [tsa].[ics_land_m3v7_OINVOH]' ;
go
...
go
print N'Creating [tsa].[ics_land_m3v7_OINVOL]' ;
go
create table [tsa].[ics_land_m3v7_OINVOL]
(
  EtlBatchRunId int not null
, EtlStepRunId int not null
, EtlThreadRunId int not null
...
, EtlCreatedOn datetime not null
, EtlCreatedBy varchar(200) not null
, ExcludeFromMerge bit not null constraint DF_tsa_ics_land_m3v7_OINVOL_ExcludeFromMerge default (0)
, IsDuplicate bit not null constraint DF_tsa_ics_land_m3v7_OINVOL_IsDuplicate default (0)
...
go
print N'Creating [tsa].[ics_land_m3v7_OOHEAD]' ;
go
...
go
print N'Creating [tsa].[ics_land_m3v7_OOLINE]' ;
go
create table [tsa].[ics_land_m3v7_OOLINE]
(
  EtlBatchRunId int not null
, EtlStepRunId int not null
, EtlThreadRunId int not null
...
, EtlCreatedOn datetime not null
, EtlCreatedBy varchar(200) not null
, ExcludeFromMerge bit not null constraint DF_tsa_ics_land_m3v7_OOLINE_ExcludeFromMerge default (0)
, IsDuplicate bit not null constraint DF_tsa_ics_land_m3v7_OOLINE_IsDuplicate default (0)
...
go
print N'Creating [tsa].[ics_land_m3v7_OSBSTD]' ;
go
