-- <Migration ID="5801eca0-27ce-457e-b380-8f9e35e01122" />
go

print N'Dropping [psa].[ics_stg_m3v7_...] tables' ;
go
if objectpropertyex(object_id(N'[psa].[ics_stg_m3v7_CCURRA]'), N'IsUserTable') is not null drop table [psa].[ics_stg_m3v7_CCURRA]
go
if objectpropertyex(object_id(N'[psa].[ics_stg_m3v7_CSYTAB]'), N'IsUserTable') is not null drop table [psa].[ics_stg_m3v7_CSYTAB]
go
if objectpropertyex(object_id(N'[psa].[ics_stg_m3v7_MILOMA]'), N'IsUserTable') is not null drop table [psa].[ics_stg_m3v7_MILOMA]
go
if objectpropertyex(object_id(N'[psa].[ics_stg_m3v7_MITAUN]'), N'IsUserTable') is not null drop table [psa].[ics_stg_m3v7_MITAUN]
go
if objectpropertyex(object_id(N'[psa].[ics_stg_m3v7_MITBAL]'), N'IsUserTable') is not null drop table [psa].[ics_stg_m3v7_MITBAL]
go
if objectpropertyex(object_id(N'[psa].[ics_stg_m3v7_MITFAC]'), N'IsUserTable') is not null drop table [psa].[ics_stg_m3v7_MITFAC]
go
if objectpropertyex(object_id(N'[psa].[ics_stg_m3v7_MITLOC]'), N'IsUserTable') is not null drop table [psa].[ics_stg_m3v7_MITLOC]
go
if objectpropertyex(object_id(N'[psa].[ics_stg_m3v7_MITMAS]'), N'IsUserTable') is not null drop table [psa].[ics_stg_m3v7_MITMAS]
go
if objectpropertyex(object_id(N'[psa].[ics_stg_m3v7_MITPOP]'), N'IsUserTable') is not null drop table [psa].[ics_stg_m3v7_MITPOP]
go
if objectpropertyex(object_id(N'[psa].[ics_stg_m3v7_OCHCUS]'), N'IsUserTable') is not null drop table [psa].[ics_stg_m3v7_OCHCUS]
go
if objectpropertyex(object_id(N'[psa].[ics_stg_m3v7_OCUSMA]'), N'IsUserTable') is not null drop table [psa].[ics_stg_m3v7_OCUSMA]
go
if objectpropertyex(object_id(N'[psa].[ics_stg_m3v7_OINVOH]'), N'IsUserTable') is not null drop table [psa].[ics_stg_m3v7_OINVOH]
go
if objectpropertyex(object_id(N'[psa].[ics_stg_m3v7_OINVOL]'), N'IsUserTable') is not null drop table [psa].[ics_stg_m3v7_OINVOL]
go
if objectpropertyex(object_id(N'[psa].[ics_stg_m3v7_OOHEAD]'), N'IsUserTable') is not null drop table [psa].[ics_stg_m3v7_OOHEAD]
go
if objectpropertyex(object_id(N'[psa].[ics_stg_m3v7_OOLINE]'), N'IsUserTable') is not null drop table [psa].[ics_stg_m3v7_OOLINE]
go
if objectpropertyex(object_id(N'[psa].[ics_stg_m3v7_OSBSTD]'), N'IsUserTable') is not null drop table [psa].[ics_stg_m3v7_OSBSTD]
go
print N'Creating [psa].[ics_stg_m3v7_CCURRA]' ;
go
...
go
print N'Creating [psa].[ics_stg_m3v7_CSYTAB]' ;
go
...
go
print N'Creating [psa].[ics_stg_m3v7_MILOMA]' ;
go
create table [psa].[ics_stg_m3v7_MILOMA]
(
  EtlRecordId bigint not null identity(1,1)
, EtlBatchRunId int not null
, EtlStepRunId int not null
...
, EtlDeletedOn datetime null
, EtlDeletedBy varchar(200) null
, IsDeleted char(1) not null constraint DF_psa_ics_stg_m3v7_MILOMA_IsDeleted default ('N')
, IsIncomplete char(1) not null constraint DF_psa_ics_stg_m3v7_MILOMA_IsIncomplete default ('N')
...
go
print N'Creating [psa].[ics_stg_m3v7_MITAUN]' ;
go
...
go
print N'Creating [psa].[ics_stg_m3v7_MITBAL]' ;
go
...
go
print N'Creating [psa].[ics_stg_m3v7_MITFAC]' ;
go
create table [psa].[ics_stg_m3v7_MITFAC]
(
  EtlRecordId bigint not null identity(1,1)
, EtlBatchRunId int not null
, EtlStepRunId int not null
...
go
print N'Creating [psa].[ics_stg_m3v7_MITLOC]' ;
go
...
go
print N'Creating [psa].[ics_stg_m3v7_MITMAS]' ;
go
...
go
print N'Creating [psa].[ics_stg_m3v7_MITPOP]' ;
go
create table [psa].[ics_stg_m3v7_MITPOP]
(
  EtlRecordId bigint not null identity(1,1)
, EtlBatchRunId int not null
, EtlStepRunId int not null
...
go
print N'Creating [psa].[ics_stg_m3v7_OCHCUS]' ;
go
...
go
print N'Creating [psa].[ics_stg_m3v7_OCUSMA]' ;
go
create table [psa].[ics_stg_m3v7_OCUSMA]
(
  EtlRecordId bigint not null identity(1,1)
, EtlBatchRunId int not null
, EtlStepRunId int not null
...
, EtlDeletedOn datetime null
, EtlDeletedBy varchar(200) null
, IsDeleted char(1) not null constraint DF_psa_ics_stg_m3v7_OCUSMA_IsDeleted default ('N')
, IsIncomplete char(1) not null constraint DF_psa_ics_stg_m3v7_OCUSMA_IsIncomplete default ('N')
...
go
print N'Creating [psa].[ics_stg_m3v7_OINVOH]' ;
go
create table [psa].[ics_stg_m3v7_OINVOH]
(
  EtlRecordId bigint not null identity(1,1)
, EtlBatchRunId int not null
, EtlStepRunId int not null
...
, EtlDeletedOn datetime null
, EtlDeletedBy varchar(200) null
, IsDeleted char(1) not null constraint DF_psa_ics_stg_m3v7_OINVOH_IsDeleted default ('N')
, IsIncomplete char(1) not null constraint DF_psa_ics_stg_m3v7_OINVOH_IsIncomplete default ('N')
...
go
print N'Creating [psa].[ics_stg_m3v7_OINVOL]' ;
go
...
go
print N'Creating [psa].[ics_stg_m3v7_OOHEAD]' ;
go
...
go
print N'Creating [psa].[ics_stg_m3v7_OOLINE]' ;
go
...
go
print N'Creating [psa].[ics_stg_m3v7_OSBSTD]' ;
go
create table [psa].[ics_stg_m3v7_OSBSTD]
(
  EtlRecordId bigint not null identity(1,1)
, EtlBatchRunId int not null
, EtlStepRunId int not null
...
, EtlDeletedOn datetime null
, EtlDeletedBy varchar(200) null
, IsDeleted char(1) not null constraint DF_psa_ics_stg_m3v7_OSBSTD_IsDeleted default ('N')
, IsIncomplete char(1) not null constraint DF_psa_ics_stg_m3v7_OSBSTD_IsIncomplete default ('N')
