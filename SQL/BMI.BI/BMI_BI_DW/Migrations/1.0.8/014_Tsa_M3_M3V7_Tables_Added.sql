-- <Migration ID="34b7a85d-ef6b-4b4f-a0fe-3711eb3fc145" />
GO
...
[ExcludeFromMerge] [bit] NOT NULL CONSTRAINT [DF_tsa_ics_land_m3_CIDADR_ExcludeFromMerge] DEFAULT ((0)),
[IsDuplicate] [bit] NOT NULL CONSTRAINT [DF_tsa_ics_land_m3_CIDADR_IsDuplicate] DEFAULT ((0)),
...
GO
CREATE CLUSTERED INDEX [tsa_ics_land_m3_CIDADR_1] ON [tsa].[ics_land_m3_CIDADR] ([SASUNO], [SAADTE], [SAADID], [SASTDT])
GO
...
[EtlCreatedOn] [datetime] NOT NULL,
[EtlCreatedBy] [varchar] (200) NOT NULL,
[ExcludeFromMerge] [bit] NOT NULL CONSTRAINT [DF_tsa_ics_land_m3_CIDMAS_ExcludeFromMerge] DEFAULT ((0)),
[IsDuplicate] [bit] NOT NULL CONSTRAINT [DF_tsa_ics_land_m3_CIDMAS_IsDuplicate] DEFAULT ((0)),
...
[EtlCreatedOn] [datetime] NOT NULL,
[EtlCreatedBy] [varchar] (200) NOT NULL,
[ExcludeFromMerge] [bit] NOT NULL CONSTRAINT [DF_tsa_ics_land_m3_CMNDIV_ExcludeFromMerge] DEFAULT ((0)),
[IsDuplicate] [bit] NOT NULL CONSTRAINT [DF_tsa_ics_land_m3_CMNDIV_IsDuplicate] DEFAULT ((0)),
...
GO
CREATE CLUSTERED INDEX [tsa_ics_land_m3_CMNDIV_1] ON [tsa].[ics_land_m3_CMNDIV] ([CCCONO], [CCDIVI])
GO
...
[EtlCreatedOn] [datetime] NOT NULL,
[EtlCreatedBy] [varchar] (200) NOT NULL,
[ExcludeFromMerge] [bit] NOT NULL CONSTRAINT [DF_tsa_ics_land_m3_MITWHL_ExcludeFromMerge] DEFAULT ((0)),
[IsDuplicate] [bit] NOT NULL CONSTRAINT [DF_tsa_ics_land_m3_MITWHL_IsDuplicate] DEFAULT ((0)),
...
GO
CREATE CLUSTERED INDEX [tsa_ics_land_m3_MITWHL_1] ON [tsa].[ics_land_m3_MITWHL] ([MWCONO], [MWWHLO])
GO
...
[EtlCreatedOn] [datetime] NOT NULL,
[EtlCreatedBy] [varchar] (200) NOT NULL,
[ExcludeFromMerge] [bit] NOT NULL CONSTRAINT [DF_tsa_ics_land_m3v7_CIDMAS_ExcludeFromMerge] DEFAULT ((0)),
[IsDuplicate] [bit] NOT NULL CONSTRAINT [DF_tsa_ics_land_m3v7_CIDMAS_IsDuplicate] DEFAULT ((0)),
[IDCONO] [decimal] (3, 0) NULL,
[IDSUNO] [nvarchar] (255) NULL,
[IDSUTY] [decimal] (1, 0) NULL,
[IDSUNM] [nvarchar] (255) NULL,
...
[EtlCreatedOn] [datetime] NOT NULL,
[EtlCreatedBy] [varchar] (200) NOT NULL,
[ExcludeFromMerge] [bit] NOT NULL CONSTRAINT [DF_tsa_ics_land_m3v7_MITWHL_ExcludeFromMerge] DEFAULT ((0)),
[IsDuplicate] [bit] NOT NULL CONSTRAINT [DF_tsa_ics_land_m3v7_MITWHL_IsDuplicate] DEFAULT ((0)),
[MWCONO] [decimal] (3, 0) NULL,
[MWWHLO] [nvarchar] (255) NULL,
[MWWHNM] [nvarchar] (255) NULL,
[MWDIVI] [nvarchar] (255) NULL,
