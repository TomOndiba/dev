-- <Migration ID="e84ecada-8cf3-499d-9569-5f31ba614958" />
GO

PRINT N'Creating [psa].[ics_stg_Navision_Bul_Purchase_Code]'
GO
CREATE TABLE [psa].[ics_stg_Navision_Bul_Purchase_Code]
(
...
[IsDeleted] [char] (1) NOT NULL CONSTRAINT [DF_psa_ics_stg_Navision_Bul_Purchase_Code_IsDeleted] DEFAULT ('N'),
[IsIncomplete] [char] (1) NOT NULL CONSTRAINT [DF_psa_ics_stg_Navision_Bul_Purchase_Code_IsIncomplete] DEFAULT ('N'),
...
GO
PRINT N'Creating primary key [PK_psa_ics_stg_Navision_Bul_Purchase_Code] on [psa].[ics_stg_Navision_Bul_Purchase_Code]'
GO
ALTER TABLE [psa].[ics_stg_Navision_Bul_Purchase_Code] ADD CONSTRAINT [PK_psa_ics_stg_Navision_Bul_Purchase_Code] PRIMARY KEY CLUSTERED  ([Code])
GO
PRINT N'Creating [psa].[ics_stg_Navision_Bul_Purchase_Header]'
GO
CREATE TABLE [psa].[ics_stg_Navision_Bul_Purchase_Header]
(
[EtlRecordId] [bigint] NOT NULL IDENTITY(1, 1),
[EtlBatchRunId] [int] NOT NULL,
[EtlStepRunId] [int] NOT NULL,
...
[EtlDeletedOn] [datetime] NULL,
[EtlDeletedBy] [varchar] (200) NULL,
[IsDeleted] [char] (1) NOT NULL CONSTRAINT [DF_psa_ics_stg_Navision_Bul_Purchase_Header_IsDeleted] DEFAULT ('N'),
[IsIncomplete] [char] (1) NOT NULL CONSTRAINT [DF_psa_ics_stg_Navision_Bul_Purchase_Header_IsIncomplete] DEFAULT ('N'),
...
GO
PRINT N'Creating primary key [PK_psa_ics_stg_Navision_Bul_Purchase_Header] on [psa].[ics_stg_Navision_Bul_Purchase_Header]'
GO
ALTER TABLE [psa].[ics_stg_Navision_Bul_Purchase_Header] ADD CONSTRAINT [PK_psa_ics_stg_Navision_Bul_Purchase_Header] PRIMARY KEY CLUSTERED  ([Document Type], [No_])
GO
PRINT N'Creating [psa].[ics_stg_Navision_Bul_Purchase_Invoice_Header]'
GO
CREATE TABLE [psa].[ics_stg_Navision_Bul_Purchase_Invoice_Header]
(
[EtlRecordId] [bigint] NOT NULL IDENTITY(1, 1),
[EtlBatchRunId] [int] NOT NULL,
[EtlStepRunId] [int] NOT NULL,
...
[EtlDeletedOn] [datetime] NULL,
[EtlDeletedBy] [varchar] (200) NULL,
[IsDeleted] [char] (1) NOT NULL CONSTRAINT [DF_psa_ics_stg_Navision_Bul_Purchase_Invoice_Header_IsDeleted] DEFAULT ('N'),
[IsIncomplete] [char] (1) NOT NULL CONSTRAINT [DF_psa_ics_stg_Navision_Bul_Purchase_Invoice_Header_IsIncomplete] DEFAULT ('N'),
[No_] [varchar] (20) NOT NULL,
[Buy-from Vendor No_] [varchar] (20) NULL,
[Pay-to Vendor No_] [varchar] (20) NULL,
[Pay-to Name] [varchar] (50) NULL,
...
GO
PRINT N'Creating primary key [PK_psa_ics_stg_Navision_Bul_Purchase_Invoice_Header] on [psa].[ics_stg_Navision_Bul_Purchase_Invoice_Header]'
GO
ALTER TABLE [psa].[ics_stg_Navision_Bul_Purchase_Invoice_Header] ADD CONSTRAINT [PK_psa_ics_stg_Navision_Bul_Purchase_Invoice_Header] PRIMARY KEY CLUSTERED  ([No_])
GO
PRINT N'Creating [psa].[ics_stg_Navision_Bul_Purchase_Invoice_Line]'
GO
CREATE TABLE [psa].[ics_stg_Navision_Bul_Purchase_Invoice_Line]
(
[EtlRecordId] [bigint] NOT NULL IDENTITY(1, 1),
[EtlBatchRunId] [int] NOT NULL,
[EtlStepRunId] [int] NOT NULL,
...
[EtlDeletedOn] [datetime] NULL,
[EtlDeletedBy] [varchar] (200) NULL,
[IsDeleted] [char] (1) NOT NULL CONSTRAINT [DF_psa_ics_stg_Navision_Bul_Purchase_Invoice_Line_IsDeleted] DEFAULT ('N'),
[IsIncomplete] [char] (1) NOT NULL CONSTRAINT [DF_psa_ics_stg_Navision_Bul_Purchase_Invoice_Line_IsIncomplete] DEFAULT ('N'),
...
GO
PRINT N'Creating primary key [PK_psa_ics_stg_Navision_Bul_Purchase_Invoice_Line] on [psa].[ics_stg_Navision_Bul_Purchase_Invoice_Line]'
GO
ALTER TABLE [psa].[ics_stg_Navision_Bul_Purchase_Invoice_Line] ADD CONSTRAINT [PK_psa_ics_stg_Navision_Bul_Purchase_Invoice_Line] PRIMARY KEY CLUSTERED  ([Document No_], [No_])
GO
PRINT N'Creating [psa].[ics_stg_Navision_Bul_Purchase_Line]'
GO
CREATE TABLE [psa].[ics_stg_Navision_Bul_Purchase_Line]
(
[EtlRecordId] [bigint] NOT NULL IDENTITY(1, 1),
[EtlBatchRunId] [int] NOT NULL,
[EtlStepRunId] [int] NOT NULL,
...
[EtlDeletedOn] [datetime] NULL,
[EtlDeletedBy] [varchar] (200) NULL,
[IsDeleted] [char] (1) NOT NULL CONSTRAINT [DF_psa_ics_stg_Navision_Bul_Purchase_Line_IsDeleted] DEFAULT ('N'),
[IsIncomplete] [char] (1) NOT NULL CONSTRAINT [DF_psa_ics_stg_Navision_Bul_Purchase_Line_IsIncomplete] DEFAULT ('N'),
[Document Type] [int] NOT NULL,
[Document No_] [varchar] (20) NOT NULL,
[Line No_] [int] NULL,
[Buy-from Vendor No_] [varchar] (20) NULL,
...
GO
PRINT N'Creating primary key [PK_psa_ics_stg_Navision_Bul_Purchase_Line] on [psa].[ics_stg_Navision_Bul_Purchase_Line]'
GO
ALTER TABLE [psa].[ics_stg_Navision_Bul_Purchase_Line] ADD CONSTRAINT [PK_psa_ics_stg_Navision_Bul_Purchase_Line] PRIMARY KEY CLUSTERED  ([Document Type], [Document No_], [No_])
GO
PRINT N'Creating [psa].[ics_stg_Navision_Bul_Purchase_Line_Discount]'
GO
CREATE TABLE [psa].[ics_stg_Navision_Bul_Purchase_Line_Discount]
(
[EtlRecordId] [bigint] NOT NULL IDENTITY(1, 1),
[EtlBatchRunId] [int] NOT NULL,
[EtlStepRunId] [int] NOT NULL,
...
[EtlDeletedOn] [datetime] NULL,
[EtlDeletedBy] [varchar] (200) NULL,
[IsDeleted] [char] (1) NOT NULL CONSTRAINT [DF_psa_ics_stg_Navision_Bul_Purchase_Line_Discount_IsDeleted] DEFAULT ('N'),
[IsIncomplete] [char] (1) NOT NULL CONSTRAINT [DF_psa_ics_stg_Navision_Bul_Purchase_Line_Discount_IsIncomplete] DEFAULT ('N'),
...
GO
PRINT N'Creating primary key [PK_psa_ics_stg_Navision_Bul_Purchase_Line_Discount] on [psa].[ics_stg_Navision_Bul_Purchase_Line_Discount]'
GO
ALTER TABLE [psa].[ics_stg_Navision_Bul_Purchase_Line_Discount] ADD CONSTRAINT [PK_psa_ics_stg_Navision_Bul_Purchase_Line_Discount] PRIMARY KEY CLUSTERED  ([Item No_], [Vendor No_], [Starting Date], [Currency Code], [Variant Code], [Unit of Measure Code], [Minimum Quantity])
GO
PRINT N'Creating [psa].[ics_stg_Navision_Bul_Purchase_Payables_Setup]'
GO
CREATE TABLE [psa].[ics_stg_Navision_Bul_Purchase_Payables_Setup]
(
[EtlRecordId] [bigint] NOT NULL IDENTITY(1, 1),
[EtlBatchRunId] [int] NOT NULL,
[EtlStepRunId] [int] NOT NULL,
...
[EtlDeletedOn] [datetime] NULL,
[EtlDeletedBy] [varchar] (200) NULL,
[IsDeleted] [char] (1) NOT NULL CONSTRAINT [DF_psa_ics_stg_Navision_Bul_Purchase_Payables_Setup_IsDeleted] DEFAULT ('N'),
[IsIncomplete] [char] (1) NOT NULL CONSTRAINT [DF_psa_ics_stg_Navision_Bul_Purchase_Payables_Setup_IsIncomplete] DEFAULT ('N'),
[timestamp] [binary] (16) NULL,
...
GO
PRINT N'Creating primary key [PK_psa_ics_stg_Navision_Bul_Purchase_Payables_Setup] on [psa].[ics_stg_Navision_Bul_Purchase_Payables_Setup]'
GO
ALTER TABLE [psa].[ics_stg_Navision_Bul_Purchase_Payables_Setup] ADD CONSTRAINT [PK_psa_ics_stg_Navision_Bul_Purchase_Payables_Setup] PRIMARY KEY CLUSTERED  ([Primary_Key])
GO
PRINT N'Creating [psa].[ics_stg_Navision_Bul_Purchase_PrePayment_Pct]'
GO
CREATE TABLE [psa].[ics_stg_Navision_Bul_Purchase_PrePayment_Pct]
(
[EtlRecordId] [bigint] NOT NULL IDENTITY(1, 1),
[EtlBatchRunId] [int] NOT NULL,
[EtlStepRunId] [int] NOT NULL,
...
[EtlDeletedOn] [datetime] NULL,
[EtlDeletedBy] [varchar] (200) NULL,
[IsDeleted] [char] (1) NOT NULL CONSTRAINT [DF_psa_ics_stg_Navision_Bul_Purchase_PrePayment_Pct_IsDeleted] DEFAULT ('N'),
[IsIncomplete] [char] (1) NOT NULL CONSTRAINT [DF_psa_ics_stg_Navision_Bul_Purchase_PrePayment_Pct_IsIncomplete] DEFAULT ('N'),
[Item No_] [varchar] (20) NOT NULL,
[Vendor No_] [varchar] (20) NOT NULL,
[Starting Date] [datetime] NOT NULL,
[Ending Date] [datetime] NULL,
...
GO
PRINT N'Creating primary key [PK_psa_ics_stg_Navision_Bul_Purchase_PrePayment_Pct] on [psa].[ics_stg_Navision_Bul_Purchase_PrePayment_Pct]'
GO
ALTER TABLE [psa].[ics_stg_Navision_Bul_Purchase_PrePayment_Pct] ADD CONSTRAINT [PK_psa_ics_stg_Navision_Bul_Purchase_PrePayment_Pct] PRIMARY KEY CLUSTERED  ([Item No_], [Vendor No_], [Starting Date])
GO
PRINT N'Creating [psa].[ics_stg_Navision_Bul_Purchase_Price]'
GO
CREATE TABLE [psa].[ics_stg_Navision_Bul_Purchase_Price]
(
[EtlRecordId] [bigint] NOT NULL IDENTITY(1, 1),
[EtlBatchRunId] [int] NOT NULL,
[EtlStepRunId] [int] NOT NULL,
...
[EtlDeletedOn] [datetime] NULL,
[EtlDeletedBy] [varchar] (200) NULL,
[IsDeleted] [char] (1) NOT NULL CONSTRAINT [DF_psa_ics_stg_Navision_Bul_Purchase_Price_IsDeleted] DEFAULT ('N'),
[IsIncomplete] [char] (1) NOT NULL CONSTRAINT [DF_psa_ics_stg_Navision_Bul_Purchase_Price_IsIncomplete] DEFAULT ('N'),
[Item No_] [varchar] (20) NOT NULL,
[Vendor No_] [varchar] (20) NOT NULL,
[Starting Date] [datetime] NOT NULL,
[Currency Code] [varchar] (10) NOT NULL,
...
GO
PRINT N'Creating primary key [PK_psa_ics_stg_Navision_Bul_Purchase_Price] on [psa].[ics_stg_Navision_Bul_Purchase_Price]'
GO
ALTER TABLE [psa].[ics_stg_Navision_Bul_Purchase_Price] ADD CONSTRAINT [PK_psa_ics_stg_Navision_Bul_Purchase_Price] PRIMARY KEY CLUSTERED  ([Item No_], [Vendor No_], [Starting Date], [Currency Code], [Variant Code], [Unit of Measure Code], [Minimum Quantity])
GO
PRINT N'Creating [psa].[ics_stg_Navision_Bul_SalesPerson_Purchaser]'
GO
CREATE TABLE [psa].[ics_stg_Navision_Bul_SalesPerson_Purchaser]
(
[EtlRecordId] [bigint] NOT NULL IDENTITY(1, 1),
[EtlBatchRunId] [int] NOT NULL,
[EtlStepRunId] [int] NOT NULL,
...
[EtlDeletedOn] [datetime] NULL,
[EtlDeletedBy] [varchar] (200) NULL,
[IsDeleted] [char] (1) NOT NULL CONSTRAINT [DF_psa_ics_stg_Navision_Bul_SalesPerson_Purchaser_IsDeleted] DEFAULT ('N'),
[IsIncomplete] [char] (1) NOT NULL CONSTRAINT [DF_psa_ics_stg_Navision_Bul_SalesPerson_Purchaser_IsIncomplete] DEFAULT ('N'),
...
GO
PRINT N'Creating primary key [PK_psa_ics_stg_Navision_Bul_SalesPerson_Purchaser] on [psa].[ics_stg_Navision_Bul_SalesPerson_Purchaser]'
GO
ALTER TABLE [psa].[ics_stg_Navision_Bul_SalesPerson_Purchaser] ADD CONSTRAINT [PK_psa_ics_stg_Navision_Bul_SalesPerson_Purchaser] PRIMARY KEY CLUSTERED  ([Code])
GO
PRINT N'Creating [psa].[ics_stg_Navision_Bul_Std_Purchase_Line]'
GO
CREATE TABLE [psa].[ics_stg_Navision_Bul_Std_Purchase_Line]
(
[EtlRecordId] [bigint] NOT NULL IDENTITY(1, 1),
[EtlBatchRunId] [int] NOT NULL,
[EtlStepRunId] [int] NOT NULL,
...
[EtlDeletedOn] [datetime] NULL,
[EtlDeletedBy] [varchar] (200) NULL,
[IsDeleted] [char] (1) NOT NULL CONSTRAINT [DF_psa_ics_stg_Navision_Bul_Std_Purchase_Line_IsDeleted] DEFAULT ('N'),
[IsIncomplete] [char] (1) NOT NULL CONSTRAINT [DF_psa_ics_stg_Navision_Bul_Std_Purchase_Line_IsIncomplete] DEFAULT ('N'),
...
GO
PRINT N'Creating primary key [PK_psa_ics_stg_Navision_Bul_Std_Purchase_Line] on [psa].[ics_stg_Navision_Bul_Std_Purchase_Line]'
GO
ALTER TABLE [psa].[ics_stg_Navision_Bul_Std_Purchase_Line] ADD CONSTRAINT [PK_psa_ics_stg_Navision_Bul_Std_Purchase_Line] PRIMARY KEY CLUSTERED  ([Standard Purchase Code], [Line No_])
GO
