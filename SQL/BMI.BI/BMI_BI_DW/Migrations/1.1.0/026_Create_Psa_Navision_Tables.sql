-- <Migration ID="dfb3ff92-0bf9-4991-a04b-8985cb9b7e70" />
GO
...
GO
PRINT N'Creating [psa].[ics_stg_Navision_Rom_Live Icopal Romania1812$Purch_ Inv_ Header]'
GO
...
GO
PRINT N'Creating [psa].[ics_stg_Navision_Rom_Live Icopal Romania1812$Purchase Header]'
GO
CREATE TABLE [psa].[ics_stg_Navision_Rom_Live Icopal Romania1812$Purchase Header]
(
[EtlRecordId] [bigint] NOT NULL IDENTITY(1, 1),
[EtlBatchRunId] [int] NOT NULL,
[EtlStepRunId] [int] NOT NULL,
...
[EtlDeletedOn] [datetime] NULL,
[EtlDeletedBy] [varchar] (200) NULL,
[IsDeleted] [char] (1) NOT NULL CONSTRAINT [DF_psa_ics_stg_Navision_Rom_Live Icopal Romania1812$Purchase Header_IsDeleted] DEFAULT ('N'),
[IsIncomplete] [char] (1) NOT NULL CONSTRAINT [DF_psa_ics_stg_Navision_Rom_Live Icopal Romania1812$Purchase Header_IsIncomplete] DEFAULT ('N'),
[Applies-to Doc_ No_] [varchar] (20) NULL,
[Applies-to Doc_ Type] [int] NULL,
[Applies-to ID] [varchar] (20) NULL,
[Area] [varchar] (10) NULL,
...
GO
PRINT N'Creating [psa].[ics_stg_Navision_Rom_Live Icopal Romania1812$Purchase Line]'
GO
...
GO
PRINT N'Creating [psa].[ics_stg_Navision_Rom_Live Icopal Romania1812$Purch_ Inv_ Line]'
GO
CREATE TABLE [psa].[ics_stg_Navision_Rom_Live Icopal Romania1812$Purch_ Inv_ Line]
(
[EtlRecordId] [bigint] NOT NULL IDENTITY(1, 1),
[EtlBatchRunId] [int] NOT NULL,
[EtlStepRunId] [int] NOT NULL,
...
[EtlDeletedOn] [datetime] NULL,
[EtlDeletedBy] [varchar] (200) NULL,
[IsDeleted] [char] (1) NOT NULL CONSTRAINT [DF_psa_ics_stg_Navision_Rom_Live Icopal Romania1812$Purch_ Inv_ Line_IsDeleted] DEFAULT ('N'),
[IsIncomplete] [char] (1) NOT NULL CONSTRAINT [DF_psa_ics_stg_Navision_Rom_Live Icopal Romania1812$Purch_ Inv_ Line_IsIncomplete] DEFAULT ('N'),
[Allow Invoice Disc_] [tinyint] NULL,
[Amount] [decimal] (38, 20) NULL,
[Amount Including VAT] [decimal] (38, 20) NULL,
[Appl_-to Item Entry] [int] NULL,
...
GO
PRINT N'Creating [psa].[ics_stg_Navision_Rom_Live Icopal Romania1812$Purchase Price]'
GO
