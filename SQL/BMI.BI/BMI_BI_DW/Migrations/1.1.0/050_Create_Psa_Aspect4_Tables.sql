-- <Migration ID="34fbbf4f-51d1-4be6-a56c-119222bbff1c" />
GO

PRINT N'Creating [psa].[ics_stg_aspect4_ordhtbli]'
GO
...
GO
PRINT N'Creating primary key [PK_stg_aspect4_ordhtbli] on [psa].[ics_stg_aspect4_ordhtbli]'
GO
ALTER TABLE [psa].[ics_stg_aspect4_ordhtbli] ADD CONSTRAINT [PK_stg_aspect4_ordhtbli] PRIMARY KEY CLUSTERED  ([ORDH_I_ORDRENR])
GO
PRINT N'Creating [psa].[ics_stg_aspect4_ordltbli]'
GO
...
GO
PRINT N'Creating primary key [PK_stg_aspect4_ordltbli] on [psa].[ics_stg_aspect4_ordltbli]'
GO
...
PRINT N'Creating [psa].[ics_stg_aspect4_modmtbl]'
GO
