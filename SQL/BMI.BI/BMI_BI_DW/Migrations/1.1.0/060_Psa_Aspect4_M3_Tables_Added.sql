-- <Migration ID="61342ace-3ed5-433f-a078-ccbe1d2ad516" />
GO

PRINT N'Dropping constraints from [psa].[ics_stg_m3_FGRECL]'
GO
ALTER TABLE [psa].[ics_stg_m3_FGRECL] DROP CONSTRAINT [PK_psa_ics_stg_M3_FGRECL]
GO
PRINT N'Creating [psa].[ics_stg_baan_tiitm001610]'
GO
CREATE TABLE [psa].[ics_stg_baan_tiitm001610]
(
...
GO
PRINT N'Creating primary key [PK_psa_ics_stg_baan_tiitm001610] on [psa].[ics_stg_baan_tiitm001610]'
GO
ALTER TABLE [psa].[ics_stg_baan_tiitm001610] ADD CONSTRAINT [PK_psa_ics_stg_baan_tiitm001610] PRIMARY KEY CLUSTERED  ([t_item])
GO
PRINT N'Altering [psa].[ics_stg_m3_FGRECL]'
GO
ALTER TABLE [psa].[ics_stg_m3_FGRECL] ALTER COLUMN [F2DIVI] [nchar] (25) NOT NULL
GO
ALTER TABLE [psa].[ics_stg_m3_FGRECL] ALTER COLUMN [F2PUNO] [nchar] (25) NOT NULL
GO
...
GO
PRINT N'Creating primary key [PK_psa_ics_stg_aspect4_VAOFTBL] on [psa].[ics_stg_aspect4_VAOFTBL]'
GO
...
GO
PRINT N'Creating primary key [PK_psa_ics_stg_aspect4_VARBTBL] on [psa].[ics_stg_aspect4_VARBTBL]'
GO
...
GO
PRINT N'Creating primary key [PK_psa_ics_stg_aspect4_VARITBL] on [psa].[ics_stg_aspect4_VARITBL]'
GO
