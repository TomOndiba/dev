-- <Migration ID="7a669cf5-ded6-4ae1-9616-36448ab40edb" />
GO

if object_id('[tsa].[ics_land_cegid_comp_fra_procure_LIGNE]', 'U') is not null
	drop table [tsa].[ics_land_cegid_comp_fra_procure_LIGNE] ;

PRINT N'Creating [tsa].[ics_land_cegid_comp_fra_procure_LIGNE]'
GO
CREATE TABLE [tsa].[ics_land_cegid_comp_fra_procure_LIGNE]
(
...
[ExcludeFromMerge] [bit] NOT NULL CONSTRAINT [DF_tsa_ics_land_cegid_comp_fra_procure_LIGNE_ExcludeFromMerge] DEFAULT ((0)),
[IsDuplicate] [bit] NOT NULL CONSTRAINT [DF_tsa_ics_land_cegid_comp_fra_procure_LIGNE_IsDuplicate] DEFAULT ((0)),
...
GO
IF OBJECT_ID('[tsa].[ics_land_cegid_comp_fra_procure_PIECE]', 'U') IS NOT NULL
	DROP TABLE [tsa].[ics_land_cegid_comp_fra_procure_PIECE]

PRINT N'Creating [tsa].[ics_land_cegid_comp_fra_procure_PIECE]'
GO
CREATE TABLE [tsa].[ics_land_cegid_comp_fra_procure_PIECE]
(
[EtlBatchRunId] [int] NOT NULL,
[EtlThreadRunId] [int] NOT NULL,
[DataSourceKey] [int] NOT NULL,
...
[EtlCreatedOn] [datetime] NOT NULL,
[EtlCreatedBy] [varchar] (200) NOT NULL,
[ExcludeFromMerge] [bit] NOT NULL CONSTRAINT [DF_tsa_ics_land_cegid_comp_fra_procure_PIECE_ExcludeFromMerge] DEFAULT ((0)),
[IsDuplicate] [bit] NOT NULL CONSTRAINT [DF_tsa_ics_land_cegid_comp_fra_procure_PIECE_IsDuplicate] DEFAULT ((0)),
[GP_NATUREPIECEG] [nvarchar] (3) NULL,
[GP_DATEPIECE] [datetime] NULL,
[GP_SOUCHE] [nvarchar] (3) NULL,
...
IF OBJECT_ID('[tsa].[ics_land_cegid_poly_fra_procure_LIGNE]', 'U') IS NOT NULL 
	DROP TABLE [tsa].[ics_land_cegid_poly_fra_procure_LIGNE]


PRINT N'Creating [tsa].[ics_land_cegid_poly_fra_procure_LIGNE]'
GO
...
IF OBJECT_ID('[tsa].[ics_land_cegid_poly_fra_procure_PIECE]', 'U') IS NOT NULL
	DROP TABLE [tsa].[ics_land_cegid_poly_fra_procure_PIECE]

PRINT N'Creating [tsa].[ics_land_cegid_poly_fra_procure_PIECE]'
GO
CREATE TABLE [tsa].[ics_land_cegid_poly_fra_procure_PIECE]
(
[EtlBatchRunId] [int] NOT NULL,
[EtlThreadRunId] [int] NOT NULL,
[DataSourceKey] [int] NOT NULL,
...
[EtlCreatedOn] [datetime] NOT NULL,
[EtlCreatedBy] [varchar] (200) NOT NULL,
[ExcludeFromMerge] [bit] NOT NULL CONSTRAINT [DF_tsa_ics_land_cegid_poly_fra_procure_PIECE_ExcludeFromMerge] DEFAULT ((0)),
[IsDuplicate] [bit] NOT NULL CONSTRAINT [DF_tsa_iics_land_cegid_poly_fra_procure_PIECE_IsDuplicate] DEFAULT ((0)),
[GP_NATUREPIECEG] [nvarchar] (3) NULL,
[GP_DATEPIECE] [datetime] NULL,
[GP_SOUCHE] [nvarchar] (3) NULL,
[GP_PRENUMERO] [nvarchar] (17) NULL,
