IF OBJECT_ID('[IcsApp].[FlattenProductCategories]') IS NOT NULL
	DROP PROCEDURE [IcsApp].[FlattenProductCategories];
...
create  procedure [IcsApp].[FlattenProductCategories] @dummyPara int
as
	begin
