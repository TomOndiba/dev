IF OBJECT_ID('[discovery].[procurement_snapshot_est_IBS_GR]') IS NOT NULL
	DROP VIEW [discovery].[procurement_snapshot_est_IBS_GR];
...
create view [discovery].[procurement_snapshot_est_IBS_GR]
as
select
...
from
	psa.ics_stg_ibs_est_procure_SROGRT	  g
