IF OBJECT_ID('[discovery].[procurement_snapshot_iScala_GR]') IS NOT NULL
	DROP VIEW [discovery].[procurement_snapshot_iScala_GR];
...
select
  ...
  , PC03017								  [EntryDate]
  ,cast(replace(cast( cast(PC03016	as date) as nvarchar(25))						,'-','') as int)	  [GoodsReceivedDate]
  , 'iScala'							  [DataSource]
