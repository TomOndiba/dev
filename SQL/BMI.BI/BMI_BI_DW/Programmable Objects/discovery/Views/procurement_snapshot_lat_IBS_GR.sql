IF OBJECT_ID('[discovery].[procurement_snapshot_lat_IBS_GR]') IS NOT NULL
	DROP VIEW [discovery].[procurement_snapshot_lat_IBS_GR];
...
create view [discovery].[procurement_snapshot_lat_IBS_GR]
as
select
  ...
  , cast(case
		 ...
		 end as decimal(16,6))			  ReceivedQuantityConverted 
from
	psa.ics_stg_ibs_lat_procure_SROGRT	  g
