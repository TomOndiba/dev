IF OBJECT_ID('[discovery].[procurement_snapshot_lit_IBS_GR]') IS NOT NULL
	DROP VIEW [discovery].[procurement_snapshot_lit_IBS_GR];
...
create view [discovery].[procurement_snapshot_lit_IBS_GR]
as
select
...
from
	psa.ics_stg_ibs_lit_procure_SROGRT	  g
