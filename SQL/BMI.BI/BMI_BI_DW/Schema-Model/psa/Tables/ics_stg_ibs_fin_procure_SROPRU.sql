CREATE TABLE [psa].[ics_stg_ibs_fin_procure_SROPRU]
(
...
[IsDeleted] [char] (1) NOT NULL CONSTRAINT [DF_psa_ics_stg_ibs_fin_procure_SROPRU_IsDeleted] DEFAULT ('N'),
[IsIncomplete] [char] (1) NOT NULL CONSTRAINT [DF_psa_ics_stg_ibs_fin_procure_SROPRU_IsIncomplete] DEFAULT ('N'),
