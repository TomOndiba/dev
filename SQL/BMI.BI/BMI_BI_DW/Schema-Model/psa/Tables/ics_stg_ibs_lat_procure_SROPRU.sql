CREATE TABLE [psa].[ics_stg_ibs_lat_procure_SROPRU]
(
...
[IsDeleted] [char] (1) NOT NULL CONSTRAINT [DF_psa_ics_stg_ibs_lat_procure_SROPRU_IsDeleted] DEFAULT ('N'),
[IsIncomplete] [char] (1) NOT NULL CONSTRAINT [DF_psa_ics_stg_ibs_lat_procure_SROPRU_IsIncomplete] DEFAULT ('N'),
...
GO
ALTER TABLE [psa].[ics_stg_ibs_lat_procure_SROPRU] ADD CONSTRAINT [pk_psa_ics_stg_ibs_lat_procure_SROPRU] PRIMARY KEY CLUSTERED  ([PJPRDC])
GO
EXEC sp_addextendedproperty N'IncludeInMerge', N'Y', 'SCHEMA', N'psa', 'TABLE', N'ics_stg_ibs_lat_procure_SROPRU', NULL, NULL
GO
