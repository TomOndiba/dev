...
[IsDeleted] [char] (1) NOT NULL CONSTRAINT [DF_psa_ics_stg_m3v7_FGINLI_IsDeleted] DEFAULT ('N'),
[IsIncomplete] [char] (1) NOT NULL CONSTRAINT [DF_psa_ics_stg_m3v7_FGINLI_IsIncomplete] DEFAULT ('N'),
[F5ACDT] [decimal] (8, 0) NULL,
[F5ADDG] [decimal] (15, 2) NULL,
[F5CHID] [nvarchar] (255) NULL,
[F5CHNO] [decimal] (3, 0) NULL,
[F5CONO] [decimal] (3, 0) NOT NULL,
...
GO
EXEC sp_addextendedproperty N'IncludeInMerge', N'Y', 'SCHEMA', N'psa', 'TABLE', N'ics_stg_m3v7_FGINLI', NULL, NULL
GO
