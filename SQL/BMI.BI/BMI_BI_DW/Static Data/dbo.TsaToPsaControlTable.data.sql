...
USING (VALUES
  (20,'2017-11-01T12:45:31.597','GROUPICOPAL\ukrna','BMI_BI_DW','tsa','ics_land_M3V10gen_POL_MITTRA','BMI_BI_DW','psa','ics_stg_M3V10gen_POL_MITTRA','Full',100147,'MTWHLO,MTTMSX,MTRGTM,MTRGDT,MTITNO,MTCONO','MTWHLO,MTTMSX,MTRGTM,MTRGDT,MTITNO,MTCONO',0)
 ,(22,'2017-11-01T12:45:31.597','GROUPICOPAL\ukrna','BMI_BI_DW','tsa','ics_land_M3V10gen_POL_MITWHL','BMI_BI_DW','psa','ics_stg_M3V10gen_POL_MITWHL','Full',100147,'MWWHLO,MWCONO','MWWHLO,MWCONO',0)
 ,(65,'2017-11-01T12:45:31.597','GROUPICOPAL\ukrna','BMI_BI_DW','tsa','ics_land_M3V10ved_POL_MITTRA','BMI_BI_DW','psa','ics_stg_M3V10ved_POL_MITTRA','Full',100140,'MTWHLO,MTTMSX,MTRGTM,MTRGDT,MTITNO,MTCONO','MTWHLO,MTTMSX,MTRGTM,MTRGDT,MTITNO,MTCONO',0)
 ,(67,'2017-11-01T12:45:31.597','GROUPICOPAL\ukrna','BMI_BI_DW','tsa','ics_land_M3V10ved_POL_MITWHL','BMI_BI_DW','psa','ics_stg_M3V10ved_POL_MITWHL','Full',100140,'MWWHLO,MWCONO','MWWHLO,MWCONO',0)
 ,(110,'2017-11-01T12:45:31.597','GROUPICOPAL\ukrna','BMI_BI_DW','tsa','ics_land_M3V10vil_POL_MITTRA','BMI_BI_DW','psa','ics_stg_M3V10vil_POL_MITTRA','Full',100141,'MTWHLO,MTTMSX,MTRGTM,MTRGDT,MTITNO,MTCONO','MTWHLO,MTTMSX,MTRGTM,MTRGDT,MTITNO,MTCONO',0)
 ,(112,'2017-11-01T12:45:31.597','GROUPICOPAL\ukrna','BMI_BI_DW','tsa','ics_land_M3V10vil_POL_MITWHL','BMI_BI_DW','psa','ics_stg_M3V10vil_POL_MITWHL','Full',100141,'MWWHLO,MWCONO','MWWHLO,MWCONO',0)
 ,(136,'2017-11-01T12:45:31.597','GROUPICOPAL\ukrna','BMI_BI_DW','tsa','ics_land_SAP_GBR_MAKT','BMI_BI_DW','psa','ics_stg_SAP_GBR_MAKT','Full',100101,'SPRAS,MATNR','SPRAS,MATNR',0)
 ,(137,'2017-11-01T12:45:31.597','GROUPICOPAL\ukrna','BMI_BI_DW','tsa','ics_land_SAP_GBR_MARA','BMI_BI_DW','psa','ics_stg_SAP_GBR_MARA','Full',100101,'MATNR','MATNR',0)
 ,(138,'2017-11-01T12:45:31.597','GROUPICOPAL\ukrna','BMI_BI_DW','tsa','ics_land_SAP_GBR_MARD','BMI_BI_DW','psa','ics_stg_SAP_GBR_MARD','Full',100101,'WERKS,MATNR,LGORT','WERKS,MATNR,LGORT',0)
 ,(139,'2017-11-01T12:45:31.597','GROUPICOPAL\ukrna','BMI_BI_DW','tsa','ics_land_SAP_GBR_T001L','BMI_BI_DW','psa','ics_stg_SAP_GBR_T001L','Full',100101,'LGORT,WERKS,MANDT','LGORT,WERKS,MANDT',0)
 ,(140,'2017-11-01T12:45:31.597','GROUPICOPAL\ukrna','BMI_BI_DW','tsa','ics_land_SAP_GBR_T001W','BMI_BI_DW','psa','ics_stg_SAP_GBR_T001W','Full',100101,'WERKS','WERKS',0)
