...
USING (VALUES
  (20,'2017-10-27T13:03:05.900','GROUPICOPAL\ukrna','BMI_BI_DW.tests','tsa','ics_land_M3V10gen_POL_MITTRA','BMI_BI_DW.tests','psa','ics_stg_M3V10gen_POL_MITTRA','Full',100147,'MTWHLO,MTTMSX,MTRGTM,MTRGDT,MTITNO,MTCONO','MTWHLO,MTTMSX,MTRGTM,MTRGDT,MTITNO,MTCONO',0)
 ,(64,'2017-10-27T13:03:05.900','GROUPICOPAL\ukrna','BMI_BI_DW.tests','tsa','ics_land_M3V10ved_POL_MITTRA','BMI_BI_DW.tests','psa','ics_stg_M3V10ved_POL_MITTRA','Full',100140,'MTWHLO,MTTMSX,MTRGTM,MTRGDT,MTITNO,MTCONO','MTWHLO,MTTMSX,MTRGTM,MTRGDT,MTITNO,MTCONO',0)
 ,(108,'2017-10-27T13:03:05.900','GROUPICOPAL\ukrna','BMI_BI_DW.tests','tsa','ics_land_M3V10vil_POL_MITTRA','BMI_BI_DW.tests','psa','ics_stg_M3V10vil_POL_MITTRA','Full',100141,'MTWHLO,MTTMSX,MTRGTM,MTRGDT,MTITNO,MTCONO','MTWHLO,MTTMSX,MTRGTM,MTRGDT,MTITNO,MTCONO',0)
 ,(133,'2017-10-27T13:03:05.900','GROUPICOPAL\ukrna','BMI_BI_DW.tests','tsa','ics_land_SAP_GBR_MAKT','BMI_BI_DW.tests','psa','ics_stg_SAP_GBR_MAKT','Full',100101,'SPRAS,MATNR','SPRAS,MATNR',0)
 ,(134,'2017-10-27T13:03:05.900','GROUPICOPAL\ukrna','BMI_BI_DW.tests','tsa','ics_land_SAP_GBR_MARD','BMI_BI_DW.tests','psa','ics_stg_SAP_GBR_MARD','Full',100101,'WERKS,MATNR,LGORT','WERKS,MATNR,LGORT',0)
 ,(135,'2017-10-27T13:03:05.900','GROUPICOPAL\ukrna','BMI_BI_DW.tests','tsa','ics_land_SAP_GBR_T001L','BMI_BI_DW.tests','psa','ics_stg_SAP_GBR_T001L','Full',100101,'LGORT,WERKS,MANDT','LGORT,WERKS,MANDT',0)
 ,(136,'2017-10-27T13:03:05.900','GROUPICOPAL\ukrna','BMI_BI_DW.tests','tsa','ics_land_SAP_GBR_T001W','BMI_BI_DW.tests','psa','ics_stg_SAP_GBR_T001W','Full',100101,'WERKS','WERKS',0)
