...
--!
--! Set the standard reporting unit of measure where available
--!
with baseCte (reporting_unit_of_measure_code, conformed_unit_of_measure_code)
as
(
		  select 'EA' , 'BX'
	union select 'EA' , 'CT'
...
(
	select
		  src.reporting_unit_of_measure_code
		, src.conformed_unit_of_measure_code
		, c.unit_of_measure_id as conformed_unit_of_measure_id
		, r.unit_of_measure_id as reporting_unit_of_measure_id
	from
		baseCte as src
	inner join dbo.unit_of_measure as c
		on c.unit_of_measure_code = src.conformed_unit_of_measure_code
	inner join dbo.unit_of_measure as r
		on r.unit_of_measure_code = src.reporting_unit_of_measure_code
)
update
	tgt
set
	tgt.reporting_unit_of_measure_id = src.reporting_unit_of_measure_id
from
	reportingUomCte as src
inner join dbo.unit_of_measure as tgt
	on tgt.unit_of_measure_id = src.conformed_unit_of_measure_id
go
