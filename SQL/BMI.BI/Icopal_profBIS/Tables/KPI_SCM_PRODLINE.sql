CREATE TABLE [dbo].[KPI_SCM_PRODLINE] (
    ...
    [OEE_SAVE_POSSIBLE_HOURS] [dbo].[D_INT]       NULL,
    CONSTRAINT [PK_KPI_SCM_PRODLINE] PRIMARY KEY CLUSTERED ([PRODLINE_ID] ASC, [KPI_YEAR] ASC, [KPI_MONTH] ASC),
    CONSTRAINT [FK_KPI_SCM_PRODLINE_MD_PLANT_PRODLINE] FOREIGN KEY ([PRODLINE_ID]) REFERENCES [dbo].[MD_PLANT_PRODLINE] ([PRODLINE_ID]) ON DELETE CASCADE
);
