CREATE TABLE [dbo].[KPI_SHIFT_PRODLINE_ITEM_DATA_BACKUP] (
    ...
    CONSTRAINT [PK_KPI_SHIFT_PRODLINE_ITEM_DATA_BACKUP] PRIMARY KEY CLUSTERED ([PRODLINE_ID] ASC, [ITEM_NO] ASC)
);
