CREATE TABLE [dbo].[KPI_SHIFT_PRODUCTION_NEW_BACKUP] (
    ...
    [PRODUCTION_ORDER]    [dbo].[D_C50]       NULL,
    ...
    CONSTRAINT [PK_KPI_SHIFT_PRODUCTION_NEW_BACKUP] PRIMARY KEY CLUSTERED ([PRODUCTION_ID] ASC)
);
