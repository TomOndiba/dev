CREATE TABLE [dbo].[PU_CATEGORY_REQUEST] (
    ...
    CONSTRAINT [PK_PU_CATEGORY_REQUEST] PRIMARY KEY CLUSTERED ([REQUEST_ID] ASC),
    CONSTRAINT [FK_PU_CATEGORY_REQUEST_PU_CATEGORY] FOREIGN KEY ([CATEGORY_ID]) REFERENCES [dbo].[PU_CATEGORY] ([CATEGORY_ID])
);
