CREATE TABLE [dbo].[SA_CUSTOMER_LOG] (
    [SYSTEM_ID]          [dbo].[D_INT]  NOT NULL,
    [CUSTOMER_NO]        [dbo].[N_C50]  NOT NULL,
    [CUSTOMER_DATE]      [dbo].[D_DATE] NOT NULL,
    ...
    CONSTRAINT [PK_SA_CUSTOMER_LOG] PRIMARY KEY CLUSTERED ([SYSTEM_ID] ASC, [CUSTOMER_NO] ASC, [CUSTOMER_DATE] ASC)
);
