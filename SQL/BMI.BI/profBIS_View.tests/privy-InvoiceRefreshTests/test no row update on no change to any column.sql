CREATE procedure [privy-InvoiceRefreshTests].[test no row update on no change to any column]
as
begin
	...
	--! Load the row that should not get updated
	...
	--! Act (Running this again should effect no change)
