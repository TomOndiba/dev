create    procedure [privy-InvoiceRefreshTests].[test source soft deletes correct rows]
as
begin
	...
	---needs not to have a value
	, EtlUpdatedBy varchar(200) collate Danish_Norwegian_CI_AS null ---
	---needs not to have a value
	, EtlDeletedOn datetime null------needs to have a value
	...
	--select * from Icopal_profBIS.dbo.SA_INVOICE;
	...
	, @_I002A_INVOICE_QUANTITY, @_I002A_INVOICE_UOM, @_I002A_STATISTIC_QUANTITY,
	 @_I002A_STATISTIC_UOM, @_I002A_QUANTITY, @_I002A_LOCAL_UOM
	, @_I002A_INVOICE_AMOUNT, @_I002A_LOCAL_AMOUNT, @_I002A_GROUP_AMOUNT
	, @_I002A_INVOICE_CURRENCY, @_I002A_LOCAL_CURRENCY
	, @_I002A_LINE_DISCOUNT_AMOUNT, @_I002A_INVOICE_DISCOUNT_AMOUNT, @_I002A_LINE_BONUS_AMOUNT,
	...
	, @_I002A_LOCAL_DELIVERY_TERM, @_I002A_LOCAL_DELIVERY_TERM_TEXT, @_I002A_LOCAL_PAYMENT_TERM, 
	@_I002A_LOCAL_PAYMENT_TERM_TEXT
	) ;
	--! Act - this second call to InvoiceRefresh should only update one record: I001(A/B)
	
	--select'stg invoice' ,* from stg.Invoice;
	--select 'invoice',* from Icopal_profBIS.dbo.SA_INVOICE
