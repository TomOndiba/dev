...
begin
	...
	declare @_I002A_InvoiceKey int = 101
		...
		, @_I002A_INVOICE_NUMBER nvarchar(20) = 'A0011'
		, @_I002A_INVOICE_LINE_NUMBER nvarchar(20) = 'B012'
		, @_I002A_ORDER_NUMBER nvarchar(20) = 'C0011'
	...
	declare @_I003B_SYSTEM_ID int  = 2
		, @_I003B_INVOICE_DATE datetime = @_I002A_INVOICE_DATE
		, @_I003B_INVOICE_NUMBER nvarchar(20) = @_I002A_INVOICE_NUMBER
		, @_I003B_INVOICE_LINE_NUMBER nvarchar(20) = @_I002A_INVOICE_LINE_NUMBER
		, @_I003B_ORDER_NUMBER nvarchar(20) = @_I002A_ORDER_NUMBER
		, @_I003B_ORDER_LINE_NUMBER nvarchar(20)  = @_I002A_ORDER_LINE_NUMBER
		, @_I003B_Uniqueifier bigint = 1
		, @_I003B_DeltaHash char(32)
		-----------------------------------------------------------
		, @_I003B_INVOICE_TYPE nvarchar(1) = '1'
		, @_I003B_InvoiceTypeName nvarchar(29)  = 'TODO: Define Invoice Type (1)'
		, @_I003B_LOCAL_SITE_SOLD nvarchar(20) = 'GB'
		, @_I003B_SITE_ID int = 14
		, @_I003B_ITEM_NO nvarchar(50) = 'HB'
		, @_I003B_ENV_CATEGORY_ID int = NULL
		, @_I003B_SOLD_TO_CUSTOMER_NO nvarchar(20) = 'IB'
		, @_I003B_SHIP_TO_CUSTOMER_NO nvarchar(20) = 'JB'
		, @_I003B_SALESPERSON_ID nvarchar(20) = 'KB'
		, @_I003B_SALESPERSON_NAME nvarchar(100) = 'LB'
		, @_I003B_DELIVERY_DATE datetime  = '20170713'
		, @_I003B_EXPECTED_PAYMENT_DATE datetime  = '20170716'
		, @_I003B_ACTUAL_PAYMENT_DATE datetime  = '20170717'
		, @_I003B_LOCAL_DELIVERY_TERM nvarchar(20) = 'MB'
		, @_I003B_LOCAL_DELIVERY_TERM_TEXT nvarchar(100) = 'PB'
		, @_I003B_LOCAL_PAYMENT_TERM nvarchar(20) = 'QB'
		, @_I003B_LOCAL_PAYMENT_TERM_TEXT nvarchar(100) = 'RB'
		, @_I003B_INVOICE_QUANTITY decimal(12, 2) = 2345.11
		, @_I003B_INVOICE_UOM nvarchar(20)  = 'SB'
		, @_I003B_STATISTIC_QUANTITY decimal(12, 2) = 2345.12
		, @_I003B_STATISTIC_UOM nvarchar(20) = 'TB'
		, @_I003B_QUANTITY decimal(12, 2) = 2345.13
		, @_I003B_LOCAL_UOM nvarchar(20) = 'UB'
		, @_I003B_LOCAL_UOM_HARMONIZED nvarchar(20) = 'VB'
		, @_I003B_LOCAL_UOM_FACTOR decimal(11, 4) = 2345.14
		, @_I003B_INVOICE_AMOUNT decimal(15, 4) = 2345.15
		, @_I003B_LOCAL_AMOUNT decimal(15, 4) = 2345.16
		, @_I003B_GROUP_AMOUNT decimal(15, 4) = 2345.17
		, @_I003B_INVOICE_CURRENCY nvarchar(3) = 'WB'
		, @_I003B_LOCAL_CURRENCY nvarchar(3) = 'XB'
		, @_I003B_LINE_DISCOUNT_AMOUNT decimal(15, 4) = 2345.18
		, @_I003B_INVOICE_DISCOUNT_AMOUNT decimal(15, 4) = 2345.19
		, @_I003B_LINE_BONUS_AMOUNT decimal(15, 4) = 2345.20
		, @_I003B_BONUS_SHARE_AMOUNT decimal(15, 4) = 2345.21
		, @_I003B_STD_COST decimal(15, 4) = 2345.22
		, @_I003B_STD_FREIGHT decimal(15, 4) = 2345.23
		, @_I003B_DuplicateCount int  = 1
	...
	values
		...
		, (@_I003B_SITE_ID, @_I003B_SYSTEM_ID, @_I003B_LOCAL_SITE_SOLD)
	...
	values
		...
		, (@_I003B_SITE_ID, @_SBU, @_I003B_SYSTEM_ID)
	...
	values
		...
		, (@_I003B_SYSTEM_ID, @_I003B_LOCAL_UOM, @_I003B_LOCAL_UOM_HARMONIZED, @_I003B_LOCAL_UOM_FACTOR)
...
*/
	...
	--! Because privy.InvoiceDeltaHash() seems to generate the MD5 hash differentlly for the same values differently
	...
	delete Icopal_profBIS.dbo.SA_INVOICE where REC_ID = @_I002A_REC_ID
	insert Icopal_profBIS.dbo.SA_INVOICE
	(
	  REC_ID
	, SYSTEM_ID, SITE_SOLD
	...
	(
	  @_I002A_REC_ID
	, @_I003B_SYSTEM_ID, @_I003B_LOCAL_SITE_SOLD
	, @_I003B_INVOICE_NUMBER, @_I003B_INVOICE_LINE_NUMBER
	, @_I003B_INVOICE_DATE, @_I003B_INVOICE_TYPE
	, @_I003B_ORDER_NUMBER, @_I003B_ORDER_LINE_NUMBER
	, @_I003B_ITEM_NO, @_I003B_SOLD_TO_CUSTOMER_NO, @_I003B_SHIP_TO_CUSTOMER_NO
	, @_I003B_INVOICE_QUANTITY, @_I003B_INVOICE_UOM, @_I003B_STATISTIC_QUANTITY, @_I003B_STATISTIC_UOM, @_I003B_QUANTITY, @_I003B_LOCAL_UOM
	, @_I003B_INVOICE_AMOUNT, @_I003B_LOCAL_AMOUNT, @_I003B_GROUP_AMOUNT
	, @_I003B_INVOICE_CURRENCY, @_I003B_LOCAL_CURRENCY
	, @_I003B_LINE_DISCOUNT_AMOUNT, @_I003B_INVOICE_DISCOUNT_AMOUNT, @_I003B_LINE_BONUS_AMOUNT, @_I003B_BONUS_SHARE_AMOUNT
	, @_I003B_STD_COST, @_I003B_STD_FREIGHT
	, @_I003B_SALESPERSON_ID, @_I003B_SALESPERSON_NAME
	, @_I003B_DELIVERY_DATE, @_I003B_EXPECTED_PAYMENT_DATE, @_I003B_ACTUAL_PAYMENT_DATE
	, @_I003B_LOCAL_DELIVERY_TERM, @_I003B_LOCAL_DELIVERY_TERM_TEXT, @_I003B_LOCAL_PAYMENT_TERM, @_I003B_LOCAL_PAYMENT_TERM_TEXT
	) ;

/*
	--! Set up any pre-existing rows
	insert stg.Invoice
	(
	  InvoiceKey
	, EtlDeltaHash
...
*/
	...
	select @_I003B_DeltaHash = EtlDeltaHash from stg.Invoice where InvoiceKey = @_I002A_InvoiceKey;
	...
	, @_I003B_SYSTEM_ID
	, @_I003B_INVOICE_DATE
	, @_I003B_INVOICE_NUMBER
	, @_I003B_INVOICE_LINE_NUMBER
	, @_I003B_ORDER_NUMBER
	, @_I003B_ORDER_LINE_NUMBER
	, @_I003B_Uniqueifier
	, @_I003B_INVOICE_TYPE
	, @_I003B_InvoiceTypeName
	, @_I003B_LOCAL_SITE_SOLD
	, @_I003B_SITE_ID
	, @_I003B_ITEM_NO
	, @_STD_ITEM_CATEGORY_ID
	, @_I003B_ENV_CATEGORY_ID
	, @_I003B_SOLD_TO_CUSTOMER_NO
	, @_I003B_SHIP_TO_CUSTOMER_NO
	, @_I003B_SALESPERSON_ID
	, @_I003B_SALESPERSON_NAME
	, @_I003B_DELIVERY_DATE
	, @_I003B_EXPECTED_PAYMENT_DATE
	, @_I003B_ACTUAL_PAYMENT_DATE
	, @_I003B_LOCAL_DELIVERY_TERM
	, @_I003B_LOCAL_DELIVERY_TERM_TEXT
	, @_STD_PAYMENT_TERM_ID
	, @_I003B_LOCAL_PAYMENT_TERM
	, @_I003B_LOCAL_PAYMENT_TERM_TEXT
	, @_I003B_INVOICE_QUANTITY
	, @_I003B_INVOICE_UOM
	, @_I003B_STATISTIC_QUANTITY
	, @_I003B_STATISTIC_UOM
	, @_I003B_QUANTITY
	, @_I003B_LOCAL_UOM
	, @_I003B_LOCAL_UOM_HARMONIZED
	, @_I003B_LOCAL_UOM_FACTOR
	, @_I003B_INVOICE_AMOUNT
	, @_I003B_LOCAL_AMOUNT
	, @_I003B_GROUP_AMOUNT
	, @_I003B_INVOICE_CURRENCY
	, @_I003B_LOCAL_CURRENCY
	, @_I003B_LINE_DISCOUNT_AMOUNT
	, @_I003B_INVOICE_DISCOUNT_AMOUNT
	, @_I003B_LINE_BONUS_AMOUNT
	, @_I003B_BONUS_SHARE_AMOUNT
	, @_I003B_STD_COST
	, @_I003B_STD_FREIGHT
	, @_I003B_DuplicateCount
	) ;
