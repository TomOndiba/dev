...
, 'Records new, changed and deleted Business Unit records (used to identify deltas on the next load)'
, 'SCHEMA', 'privy', 'PROCEDURE', 'BusinessUnitControlReset', null, null;
go
