...
, 'Records new, changed and deleted Order (SNI) records (used to identify deltas on the next load)'
, 'SCHEMA', 'privy', 'PROCEDURE', 'OrderShippedNotInvoicedControlReset', null, null;
go
