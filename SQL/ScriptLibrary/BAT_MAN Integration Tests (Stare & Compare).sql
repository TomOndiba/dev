--!
--! BAT_MAN Integration Tests (Stare & Compare).sql
--!
--!
...
exec ics.SubProcessRunStart
	...
	, @SetDate = '20020202 22:22:22' -- TODO
...
exec ics.SubProcessRunEnd
	...
	, @SubProcessRunId = @_SubProcess_RunId
	, @EndState = 'SUCCEEDED'
	, @EndMessage = 'This was a good result (sub-process)'
...
exec ics.ProcessRunEnd
	...
	, @ProcessRunId = @_Process_RunId
	, @EndState = 'SUCCEEDED'
	, @EndMessage = 'This was a good result (process)'
